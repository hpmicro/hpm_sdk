...
void init_uart_pins(UART_Type *ptr)
{
    if (ptr == HPM_UART0) {
        ...
        HPM_PIOC->PAD[IOC_PAD_PY00].FUNC_CTL = IOC_PY00_FUNC_CTL_PURT_TXD;
        HPM_PIOC->PAD[IOC_PAD_PY01].FUNC_CTL = IOC_PY01_FUNC_CTL_PURT_RXD;
    } else {
        ;
    }
}
...
#define SDXC_PIN_SETTING_COMMON (IOC_PAD_PAD_CTL_PE_SET(1) \
                                | IOC_PAD_PAD_CTL_SPD_SET(3) \
                                | IOC_PAD_PAD_CTL_SR_SET(1))
#define SDXC_PIN_SETTING        (IOC_PAD_PAD_CTL_DS_SET(3) \
...
{
    if (ptr == HPM_MCAN3) {
        HPM_IOC->PAD[IOC_PAD_PD15].FUNC_CTL = IOC_PD15_FUNC_CTL_CAN3_TXD;
        HPM_IOC->PAD[IOC_PAD_PD14].FUNC_CTL = IOC_PD14_FUNC_CTL_CAN3_RXD;
        HPM_IOC->PAD[IOC_PAD_PD13].FUNC_CTL = IOC_PD13_FUNC_CTL_CAN3_STBY;
    }
}
