...
/* LED */
#define BOARD_LED_GPIO_NAME  "PA07"
...
#define BOARD_SENT_IDLE_HIGH_GPTMR                   HPM_GPTMR2
#define BOARD_SENT_IDLE_HIGH_GPTMR_IRQ               IRQn_GPTMR2
#define BOARD_SENT_IDLE_HIGH_GPTMR_CHANNEL           2
#define BOARD_SENT_IDLE_HIGH_GPTMR_CLK_NAME          clock_gptmr2
