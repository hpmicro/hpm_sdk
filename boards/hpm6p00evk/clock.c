...
void init_dac0_clock(void)
{
    clock_add_to_group(clock_dac0, 0);
}

void init_dac1_clock(void)
{
...
void init_femc_clock(void)
{
    ...
    clock_set_source_divider(clock_femc, clk_src_pll1_clk0, 6);
...
void init_enet0_rmii_ref_pll2_postdiv(void)
{
    /*
...
void init_acmp2_clock(void)
{
    clock_add_to_group(clock_acmp2, 0);
}

void init_acmp2_clock_group1(void)
{
    clock_add_to_group(clock_acmp2, 1);
}
