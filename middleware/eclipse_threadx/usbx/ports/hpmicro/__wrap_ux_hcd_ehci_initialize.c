...
#if defined(K66) || defined(IMX6UL) || defined(XILINX_ZYNQ) || defined(MIMXRT) || defined(AZURE_USBX_HOST_HPMICRO)
...
#define UX_HCD_EHCI_EXT_USB_HOST_MODE_ENABLE(hcd_ehci)
    ...
    defined(MCF5445X) || defined(MIMXRT) || defined(AZURE_USBX_HOST_HPMICRO)
...
/*  04-17-2023     Zihan Xu                 Add Hpmicro soc support       */
/*                                                                        */
/**************************************************************************/
