...
AT_NONCACHEABLE_SECTION(static FIL f);

static void hex_dump_internal(void *avcl, FIL *f, int level,
...
void av_hex_dump(FIL *f, const uint8_t *buf, int size)
{
...
static void pkt_dump_internal(void *avcl, FIL *f, int level, const AVPacket *pkt,
                              int dump_payload, AVRational time_base)
{
;
}

void av_pkt_dump2(FIL *f, const AVPacket *pkt, int dump_payload, const AVStream *st)
{
