...
__attribute__ ((section(".fast"))) static void refill(CABACContext *c){
#if CABAC_BITS == 16
...
__attribute__ ((section(".fast"))) static inline void renorm_cabac_decoder_once(CABACContext *c){
...
#ifndef get_cabac_inline
__attribute__((section(".fast"))) static av_always_inline int get_cabac_inline(CABACContext *c, uint8_t * const state){
    int s = *state;
...
__attribute__((section(".fast"))) static int av_noinline av_unused get_cabac_noinline(CABACContext *c, uint8_t * const state){
 ...
 */
#ifndef get_cabac_terminate
__attribute__ ((section(".fast"))) static int av_unused get_cabac_terminate(CABACContext *c){
    c->range -= 2;
