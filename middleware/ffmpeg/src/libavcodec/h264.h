 ...
 */
__attribute__((section(".fast"))) static av_always_inline int pred_intra_mode(const H264Context *h,
...
__attribute__((section(".fast"))) static av_always_inline void write_back_intra_pred_mode(const H264Context *h,
                                                        H264SliceContext *sl)
{
...
__attribute__((section(".fast"))) static av_always_inline void write_back_motion(const H264Context *h,
                                               H264SliceContext *sl,
                                               int mb_type)
{
...
__attribute__((section(".fast"))) static av_always_inline int get_dct8x8_allowed(const H264Context *h, H264SliceContext *sl)
{
