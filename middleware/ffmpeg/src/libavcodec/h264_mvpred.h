 ...
 */
__attribute__((section(".fast"))) static av_always_inline void pred_motion(const H264Context *const h,
                                         H264SliceContext *sl,
                                         int n,
 ...
 * @param my the y component of the predicted motion vector
 */
__attribute__((section(".fast"))) static av_always_inline void pred_8x16_motion(const H264Context *const h,
                                              H264SliceContext *sl,
                                              int n, int list, int ref,
                                              int *const mx, int *const my)
{
...
__attribute__((section(".fast"))) static av_always_inline void pred_pskip_motion(const H264Context *const h,
                                               H264SliceContext *sl)
{
...
__attribute__((section(".fast"))) static void fill_decode_neighbors(const H264Context *h, H264SliceContext *sl, int mb_type)
{
...
__attribute__((section(".fast"))) static void fill_decode_caches(const H264Context *h, H264SliceContext *sl, int mb_type)
{
    int topleft_xy, top_xy, topright_xy, left_xy[LEFT_MBS];
 ...
 */
__attribute__((section(".fast"))) static void av_unused decode_mb_skip(const H264Context *h, H264SliceContext *sl)
{
    const int mb_xy = sl->mb_xy;
    int mb_type     = 0;
