 ...
 *
 * Project: TinyEngine
 * Title:   hpm_nn_mat_mult_kernel_s8_s16_reordered_oddch.c
 ...
 * Original Title:        hpm_nn_mat_mult_kernel_s8_s16_reordered.c
 *
 ...
 *
 * Refer header file for details. This function differs from hpm_nn_mat_mult_kernel_s8_s16(), in that it uses
 *        read_and_pad_reordered() instead of hpm_nn_mat_mult_kernel_s8_s16(). Investigating the cycles impact and
                                              ...
                                              q7_t *out_0)
{
    ...
    while (row_count)
    {
        ...
        while (col_count)
        {
			...
			q31_t b0 = hpm_nn_read_q15x2_ia(&ip_b0);
			q31_t b1 = hpm_nn_read_q15x2_ia(&ip_b1);
			...
			b0 = hpm_nn_read_q15x2_ia(&ip_b0);
			ch_1_out_1 = __SMLAD(a11, b1, ch_1_out_1);

			b1 = hpm_nn_read_q15x2_ia(&ip_b1);
        ...
        ch_0_out_0 = hpm_nn_requantize(ch_0_out_0, *out_mult, *out_shift);
        ch_0_out_0 += out_offset;
        ch_0_out_0 = MAX(ch_0_out_0, activation_min);
        ch_0_out_0 = MIN(ch_0_out_0, activation_max);
        *out_0++ = (q7_t)ch_0_out_0;

        ch_0_out_1 = hpm_nn_requantize(ch_0_out_1, *out_mult, *out_shift);
        ...
        *out_1++ = (q7_t)ch_0_out_1;
        ...
        ch_1_out_0 = hpm_nn_requantize(ch_1_out_0, *out_mult, *out_shift);
        ch_1_out_0 += out_offset;
        ch_1_out_0 = MAX(ch_1_out_0, activation_min);
        ch_1_out_0 = MIN(ch_1_out_0, activation_max);
        *out_0++ = (q7_t)ch_1_out_0;

        ch_1_out_1 = hpm_nn_requantize(ch_1_out_1, *out_mult, *out_shift);
