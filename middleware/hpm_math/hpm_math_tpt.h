 ...
 */
static inline float32_t hpm_dsp_max_f32(const float32_t *src, uint32_t size,
                                        uint32_t *index) {
 ...
 * @return maximum value.
 */
static inline q15_t hpm_dsp_max_q15(const q15_t *src, uint32_t size,
                                    uint32_t *index) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return maximum value.
 */
static inline q31_t hpm_dsp_max_q31(const q31_t *src, uint32_t size,
                                    uint32_t *index) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
  q31_t res;
 ...
 * @return maximum value.
 */
static inline q7_t hpm_dsp_max_q7(const q7_t *src, uint32_t size,
                                  uint32_t *index) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return max value.
 */
static inline uint8_t hpm_dsp_max_u8(const uint8_t *src, uint32_t size,
                                     uint32_t *index) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline float32_t hpm_dsp_min_f32(const float32_t *src, uint32_t size,
                                        uint32_t *index) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return minimum value.
 */
static inline q15_t hpm_dsp_min_q15(const q15_t *src, uint32_t size,
                                    uint32_t *index) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return minimum value.
 */
static inline q31_t hpm_dsp_min_q31(const q31_t *src, uint32_t size,
                                    uint32_t *index) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
  q31_t res;
 ...
 * @return minimum value.
 */
static inline q7_t hpm_dsp_min_q7(const q7_t *src, uint32_t size,
                                  uint32_t *index) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return minimum value.
 */
static inline uint8_t hpm_dsp_min_u8(const uint8_t *src, uint32_t size,
                                     uint32_t *index) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline uint32_t hpm_dsp_gaussian_naive_bayes_est_f32(
    const riscv_dsp_gaussian_naivebayes_f32_t *instance, const float32_t *src,
    float32_t *buf) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_abs_f32(float32_t *src, float32_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
...
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32s
#ifdef __zcc__
 ...
 * @return none.
 */
static inline void hpm_dsp_add_f32(float32_t *src1, float32_t *src2,
 ...
 */
static inline void hpm_dsp_add_q31(q31_t *src1, q31_t *src2, q31_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
 ...
 */
static inline void hpm_dsp_add_q15(q15_t *src1, q15_t *src2, q15_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_add_q7(q7_t *src1, q7_t *src2, q7_t *dst,
                                  uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_add_u8_u16(uint8_t *src1, uint8_t *src2,
                                      uint16_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_sub_f32(float32_t *src1, float32_t *src2,
                                   float32_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * Ouput results will be saturated in Q31 range [0x80000000 0x7FFFFFFF].
 */
static inline void hpm_dsp_sub_q31(q31_t *src1, q31_t *src2, q31_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
 ...
 * The output results will be saturated in Q15 range [0x8000 0x7FFF].
 */
static inline void hpm_dsp_sub_q15(q15_t *src1, q15_t *src2, q15_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * Ouput results will be saturated in Q7 range [0x80 0x7F].
 */
static inline void hpm_dsp_sub_q7(q7_t *src1, q7_t *src2, q7_t *dst,
                                  uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * Ouput results will be saturated in Q7 range [0x80 0x7F].
 */
static inline void hpm_dsp_sub_u8_q7(uint8_t *src1, uint8_t *src2, q7_t *dst,
                                     uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_mul_f32(float32_t *src1, float32_t *src2,
                                   float32_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * Ouput results will be saturated in Q31 range [0x80000000 0x7FFFFFFF].
 */
static inline void hpm_dsp_mul_q31(q31_t *src1, q31_t *src2, q31_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
 ...
 */
static inline void hpm_dsp_mul_q15(q15_t *src1, q15_t *src2, q15_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * Ouput results will be saturated in Q7 range [0x80 0x7F].
 */
static inline void hpm_dsp_mul_q7(q7_t *src1, q7_t *src2, q7_t *dst,
                                  uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_mul_u8_u16(uint8_t *src1, uint8_t *src2,
                                      uint16_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_div_f32(float32_t *src1, float32_t *src2,
                                   float32_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_neg_f32(float32_t *src, float32_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline float32_t hpm_dsp_dprod_f32(float32_t *src1, float32_t *src2,
                                          uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline q31_t hpm_dsp_dprod_u8xq15(uint8_t *src1, q15_t *src2,
                                         uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline q31_t hpm_dsp_dprod_q7xq15(q7_t *src1, q15_t *src2,
                                         uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline uint32_t hpm_dsp_dprod_u8(uint8_t *src1, uint8_t *src2,
                                        uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_offset_f32(float32_t *src, float32_t offset,
                                      float32_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_offset_q31(q31_t *src, q31_t offset, q31_t *dst,
                                      uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
 ...
 */
static inline void hpm_dsp_offset_q15(q15_t *src, q15_t offset, q15_t *dst,
                                      uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_offset_q7(q7_t *src, q7_t offset, q7_t *dst,
                                     uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_offset_u8(uint8_t *src, q7_t offset, uint8_t *dst,
                                     uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_scale_f32(float32_t *src, float32_t scale,
                                     float32_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_scale_q31(q31_t *src, q31_t scalefract, int8_t shift,
 ...
 */
static inline void hpm_dsp_scale_q15(q15_t *src, q15_t scalefract, int8_t shift,
 ...
 */
static inline void hpm_dsp_scale_q7(q7_t *src, q7_t scalefract, int8_t shift,
 ...
 */
static inline void hpm_dsp_scale_u8(uint8_t *src, q7_t scalefract, int8_t shift,
 ...
 */
static inline void hpm_dsp_shift_q15(q15_t *src, int8_t shift, q15_t *dst,
                                     uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_shift_q31(q31_t *src, int8_t shift, q31_t *dst,
                                     uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
  // #ifdef __zcc__
  //   tpt_shift_q31(dst, src, scalefract, shift, size);
  // #else
 ...
 */
static inline void hpm_dsp_shift_q7(q7_t *src, int8_t shift, q7_t *dst,
                                    uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_shift_u8(uint8_t *src, int8_t shift, uint8_t *dst,
                                    uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_cconj_f32(const float32_t *src, float32_t *dst,
                                     uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * allowable positive value INT16_MAX.
 */
static inline void hpm_dsp_cconj_q15(const q15_t *src, q15_t *dst,
                                     uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * allowable positive value INT32_MAX.
 */
static inline void hpm_dsp_cconj_q31(const q31_t *src, q31_t *dst,
                                     uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
  // #ifdef __zcc__
 ...
 */
static inline void hpm_dsp_cdprod_q15(const q15_t *src1, const q15_t *src2,
 ...
 */
static inline void hpm_dsp_cdprod_typ2_q15(const q15_t *src1, const q15_t *src2,
                                           uint32_t size, q31_t *rout,
                                           q31_t *iout) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
  // #ifdef __zcc__
  //   tpt_cmplx_dot_prod_q15(rout, iout, src1, src2, size);
  // #else
 ...
 */
static inline void hpm_dsp_cdprod_q31(const q31_t *src1, const q31_t *src2,
 ...
 */
static inline void hpm_dsp_cdprod_typ2_q31(const q31_t *src1, const q31_t *src2,
                                           uint32_t size, q63_t *rout,
                                           q63_t *iout) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
  // #ifdef __zcc__
 ...
 * @return none.
 */
static inline void hpm_dsp_cmag_f32(const float32_t *src, float32_t *dst,
                                    uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
 ...
 */
static inline void hpm_dsp_cmag_q15(const q15_t *src, q15_t *dst,
                                    uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_cmag_q31(const q31_t *src, q31_t *dst,
                                    uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_cmag_sqr_f32(const float32_t *src, float32_t *dst,
                                        uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * finally output is shift into 3.13 format.
 */
static inline void hpm_dsp_cmag_sqr_q15(const q15_t *src, q15_t *dst,
                                        uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * finally output is shift into 3.29 format.
 */
static inline void hpm_dsp_cmag_sqr_q31(const q31_t *src, q31_t *dst,
                                        uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_cmul_f32(const float32_t *src1,
                                    const float32_t *src2, float32_t *dst,
                                    uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * finally output is shift into 3.13 format.
 */
static inline void hpm_dsp_cmul_q15(const q15_t *src1, const q15_t *src2,
                                    q15_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * finally output is shift into 3.29 format.
 */
static inline void hpm_dsp_cmul_q31(const q31_t *src1, const q31_t *src2,
                                    q31_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_cmul_real_f32(const float32_t *src,
                                         const float32_t *real, float32_t *dst,
                                         uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * Output results will be saturated in Q15 range [0x8000 0x7FFF].
 */
static inline void hpm_dsp_cmul_real_q15(const q15_t *src, const q15_t *real,
                                         q15_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_cmul_real_q31(const q31_t *src, const q31_t *real,
                                         q31_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_clarke_f32(float32_t a, float32_t b,
 ...
 */
static inline void hpm_dsp_clarke_q31(q31_t a, q31_t b, q31_t *alpha,
                                      q31_t *beta) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_inv_clarke_f32(float32_t alpha, float32_t beta,
 ...
 * 31 bits of the intermediate multiplication in 2.62 format.
 */
static inline void hpm_dsp_inv_clarke_q31(q31_t alpha, q31_t beta, q31_t *a,
                                          q31_t *b) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_park_f32(float32_t alpha, float32_t beta,
                                    float32_t *a, float32_t *b, float32_t sin,
                                    float32_t cos) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * 31 bits of the intermediate multiplication in 2.62 format.
 */
static inline void hpm_dsp_park_q31(q31_t alpha, q31_t beta, q31_t *a, q31_t *b,
                                    q31_t sin, q31_t cos) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_inv_park_f32(float32_t a, float32_t b,
                                        float32_t *alpha, float32_t *beta,
                                        float32_t sin, float32_t cos) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * 31 bits of the intermediate multiplication in 2.62 format.
 */
static inline void hpm_dsp_inv_park_q31(q31_t a, q31_t b, q31_t *alpha,
                                        q31_t *beta, q31_t sin, q31_t cos) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
hpm_dsp_bdist_sokal_michener_u32_f32(const uint32_t *src1, const uint32_t *src2,
                                     uint32_t numofbool) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline float32_t hpm_dsp_bdist_rogers_tanimoto_u32_f32(
    const uint32_t *src1, const uint32_t *src2, uint32_t numofbool) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_fir_q7(const riscv_dsp_fir_q7_t *instance, q7_t *src,
                                  q7_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_dcmfir_fast_q31(const riscv_dsp_dcmfir_q31_t *instance, q31_t *src,
                        q31_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_dcmfir_fast_q15(const riscv_dsp_dcmfir_q15_t *instance, q15_t *src,
                        q15_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_upsplfir_f32(const riscv_dsp_upsplfir_f32_t *instance, float32_t *src,
                     float32_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_upsplfir_q15(const riscv_dsp_upsplfir_q15_t *instance, q15_t *src,
                     q15_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_upsplfir_q31(const riscv_dsp_upsplfir_q31_t *instance, q31_t *src,
                     q31_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_spafir_q31(riscv_dsp_spafir_q31_t *instance,
                                      q31_t *src, q31_t *dst, q31_t *buf,
                                      uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
  riscv_dsp_spafir_q31(instance, src, dst, buf, size);
#endif
}
static inline void hpm_dsp_spafir_q7(riscv_dsp_spafir_q7_t *instance, q7_t *src,
                                     q7_t *dst, q7_t *buf1, q31_t *buf2,
                                     uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_lms_f32(const riscv_dsp_lms_f32_t *instance,
                                   float32_t *src, float32_t *ref,
                                   float32_t *dst, float32_t *err,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_lms_q31(const riscv_dsp_lms_q31_t *instance,
                                   q31_t *src, q31_t *ref, q31_t *dst,
                                   q31_t *err, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_lms_q15(const riscv_dsp_lms_q15_t *instance,
                                   q15_t *src, q15_t *ref, q15_t *dst,
                                   q15_t *err, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_nlms_q31(riscv_dsp_nlms_q31_t *instance, q31_t *src,
                                    q31_t *ref, q31_t *dst, q31_t *err,
                                    uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_nlms_q15(riscv_dsp_nlms_q15_t *instance, q15_t *src,
                                    q15_t *ref, q15_t *dst, q15_t *err,
                                    uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_conv_f32(float32_t *src1, uint32_t len1,
                                    float32_t *src2, uint32_t len2,
                                    float32_t *dst) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_conv_q15(q15_t *src1, uint32_t len1, q15_t *src2,
 ...
 */
static inline void hpm_dsp_conv_q31(q31_t *src1, uint32_t len1, q31_t *src2,
 ...
 * discarding the low 7 bits and then saturated to 1.7 format.
 */
static inline void hpm_dsp_conv_q7(q7_t *src1, uint32_t len1, q7_t *src2,
 ...
 * len1+len2-2.
 */
static inline int32_t hpm_dsp_conv_partial_f32(float32_t *src1, uint32_t len1,
                                               float32_t *src2, uint32_t len2,
                                               float32_t *dst,
                                               uint32_t startindex,
                                               uint32_t size) {
 ...
 * len1+len2-2.
 */
static inline int32_t hpm_dsp_conv_partial_q15(q15_t *src1, uint32_t len1,
                                               q15_t *src2, uint32_t len2,
                                               q15_t *dst, uint32_t startindex,
                                               uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * len1+len2-2.
 */
static inline int32_t hpm_dsp_conv_partial_q31(q31_t *src1, uint32_t len1,
                                               q31_t *src2, uint32_t len2,
                                               q31_t *dst, uint32_t startindex,
                                               uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * len1+len2-2.
 */
static inline int32_t hpm_dsp_conv_partial_q7(q7_t *src1, uint32_t len1,
                                              q7_t *src2, uint32_t len2,
                                              q7_t *dst, uint32_t startindex,
                                              uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_corr_f32(float32_t *src1, uint32_t len1,
                                    float32_t *src2, uint32_t len2,
                                    float32_t *dst) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * discarding the low 15 bits and then saturated to 1.15 format.
 */
static inline void hpm_dsp_corr_q15(q15_t *src1, uint32_t len1, q15_t *src2,
                                    uint32_t len2, q15_t *dst) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_corr_q31(q31_t *src1, uint32_t len1, q31_t *src2,
                                    uint32_t len2, q31_t *dst) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * discarding the low 7 bits and then saturated to 1.7 format.
 */
static inline void hpm_dsp_corr_q7(q7_t *src1, uint32_t len1, q7_t *src2,
                                   uint32_t len2, q7_t *dst) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_bq_df1_fast_q15(const riscv_dsp_bq_df1_q15_t *instance, q15_t *src,
                        q15_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_bq_df1_fast_q31(const riscv_dsp_bq_df1_q31_t *instance, q31_t *src,
                        q31_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_bq_df1_32x64_q31(const riscv_dsp_bq_df1_32x64_q31_t *instance,
                         q31_t *src, q31_t *dst, uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_bq_stereo_df2T_f32(const riscv_dsp_bq_stereo_df2T_f32_t *instance,
 ...
 * The output results will be saturated in Q15 range [0x8000 0x7FFF].
 */
static inline void hpm_dsp_mat_add_q15(const q15_t *src1, const q15_t *src2,
 ...
 * Ouput results will be saturated in Q31 range [0x80000000 0x7FFFFFFF].
 */
static inline void hpm_dsp_mat_add_q31(const q31_t *src1, const q31_t *src2,
 ...
 */
static inline int32_t hpm_dsp_mat_inv_f32(float32_t *src, float32_t *dst,
                                          uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
  return riscv_dsp_mat_inv_f32(src, dst, size);
#endif
}
static inline int32_t hpm_dsp_mat_inv_f64(float64_t *src, float64_t *dst,
                                          uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_mat_mul_f64(const float64_t *src1,
                                       const float64_t *src2, float64_t *dst,
                                       uint32_t row, uint32_t col,
                                       uint32_t col2) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * bits, and then saturated to yield a result in 1.15 format.
 */
static inline void hpm_dsp_mat_mul_q15(const q15_t *src1, const q15_t *src2,
                                       q15_t *dst, uint32_t row, uint32_t col,
                                       uint32_t col2) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * bits, and then saturated to yield a result in 1.15 format.
 */
static inline void hpm_dsp_cmat_mul_q15(const q15_t *src1, const q15_t *src2,
                                        q15_t *dst, uint32_t row, uint32_t col,
                                        uint32_t col2) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * shifted by 31 bits to yield a 1.31 format value.
 */
static inline void hpm_dsp_mat_mul_q31(const q31_t *src1, const q31_t *src2,
                                       q31_t *dst, uint32_t row, uint32_t col,
                                       uint32_t col2) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * shifted by 31 bits to yield a 1.31 format value.
 */
static inline void hpm_dsp_cmat_mul_q31(const q31_t *src1, const q31_t *src2,
                                        q31_t *dst, uint32_t row, uint32_t col,
                                        uint32_t col2) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_mat_mul_q7(const q7_t *src1, const q7_t *src2,
 ...
 * bits, and then saturated to yield a result in 1.7 format.
 */
static inline void hpm_dsp_mat_mul_vxm_q7(const q7_t *src1, const q7_t *src2,
                                          q7_t *dst, uint32_t col,
                                          uint32_t col2) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_mat_scale_f32(const float32_t *src, float32_t scale,
                                         float32_t *dst, uint32_t row,
                                         uint32_t col) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_mat_scale_q15(const q15_t *src, q15_t scale_fract,
                                         int32_t shift, q15_t *dst,
                                         uint32_t row, uint32_t col) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 */
static inline void hpm_dsp_mat_scale_q31(const q31_t *src, q31_t scale_fract,
                                         int32_t shift, q31_t *dst,
                                         uint32_t row, uint32_t col) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * The output results will be saturated in Q15 range [0x8000 0x7FFF].
 */
static inline void hpm_dsp_mat_sub_q15(const q15_t *src1, const q15_t *src2,
                                       q15_t *dst, uint32_t row, uint32_t col) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * Ouput results will be saturated in Q31 range [0x80000000 0x7FFFFFFF].
 */
static inline void hpm_dsp_mat_sub_q31(const q31_t *src1, const q31_t *src2,
                                       q31_t *dst, uint32_t row, uint32_t col) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_mat_trans_f32(const float32_t *src, float32_t *dst,
                                         uint32_t row, uint32_t col) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_mat_trans_q15(const q15_t *src, q15_t *dst,
                                         uint32_t row, uint32_t col) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_mat_trans_q31(const q31_t *src, q31_t *dst,
                                         uint32_t row, uint32_t col) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_mat_trans_u8(const uint8_t *src, uint8_t *dst,
                                        uint32_t row, uint32_t col) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_svm_linear_est_f32(const riscv_dsp_svm_linear_f32_t *instance,
                           const float32_t *src, int32_t *result) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_svm_sigmoid_est_f32(const riscv_dsp_svm_sigmoid_f32_t *instance,
                            const float32_t *src, int32_t *result) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_svm_rbf_est_f32(const riscv_dsp_svm_rbf_f32_t *instance,
                        const float32_t *src, int32_t *result) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void
hpm_dsp_svm_poly_est_f32(const riscv_dsp_svm_poly_f32_t *instance,
                         const float32_t *src, int32_t *result) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_f32_q15(float32_t *src, q15_t *dst,
                                           uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_f32_q31(float32_t *src, q31_t *dst,
                                           uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_f32_q7(float32_t *src, q7_t *dst,
                                          uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_q15_f32(q15_t *src, float32_t *dst,
                                           uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_q15_q31(q15_t *src, q31_t *dst,
                                           uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_q15_q7(q15_t *src, q7_t *dst,
                                          uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_q31_f32(q31_t *src, float32_t *dst,
                                           uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
#ifdef __zcc__
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_q31_q15(q31_t *src, q15_t *dst,
                                           uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_q31_q7(q31_t *src, q7_t *dst,
                                          uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_q7_f32(q7_t *src, float32_t *dst,
                                          uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_q7_q15(q7_t *src, q15_t *dst,
                                          uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_convert_q7_q31(q7_t *src, q31_t *dst,
                                          uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_dup_f32(float32_t *src, float32_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
 ...
 * @return none.
 */
static inline void hpm_dsp_set_f32(float32_t val, float32_t *dst,
                                   uint32_t size) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
...
static inline void hpm_dsp_barycenter_f32(const float32_t *src,
                                          ...
                                          float32_t *out, uint32_t numofvec,
                                          uint32_t dimofvec) {
#if HPM_DSP_CORE == HPM_DSP_HW_NDS32
