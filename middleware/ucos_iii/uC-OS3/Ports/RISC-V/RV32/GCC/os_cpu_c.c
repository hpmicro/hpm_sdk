...
/* added by Hpmicro */
    ...
    *(--p_stk) = (CPU_STK) 0xb0b0b0b0uL;       /* ft30                                                 */
    *(--p_stk) = (CPU_STK) 0xa9a9a9a9uL;       /* ft29                                                 */
    *(--p_stk) = (CPU_STK) 0xa9a9a9a9uL;       /* ft29                                                 */
    *(--p_stk) = (CPU_STK) 0xa8a8a8a8uL;       /* ft28                                                 */
    *(--p_stk) = (CPU_STK) 0xa8a8a8a8uL;       /* ft28                                                 */
    *(--p_stk) = (CPU_STK) 0xa7a7a7a7uL;       /* ft27                                                 */
    *(--p_stk) = (CPU_STK) 0xa7a7a7a7uL;       /* ft27                                                 */
    *(--p_stk) = (CPU_STK) 0xa6a6a6a6uL;       /* ft26                                                 */
    *(--p_stk) = (CPU_STK) 0xa6a6a6a6uL;       /* ft26                                                 */
    *(--p_stk) = (CPU_STK) 0xa5a5a5a5uL;       /* ft25                                                 */
    *(--p_stk) = (CPU_STK) 0xa5a5a5a5uL;       /* ft25                                                 */
    *(--p_stk) = (CPU_STK) 0xa4a4a4a4uL;       /* ft24                                                 */
    *(--p_stk) = (CPU_STK) 0xa4a4a4a4uL;       /* ft24                                                 */
    *(--p_stk) = (CPU_STK) 0xa3a3a3a3uL;       /* ft23                                                 */
    *(--p_stk) = (CPU_STK) 0xa3a3a3a3uL;       /* ft23                                                 */
    *(--p_stk) = (CPU_STK) 0xa2a2a2a2uL;       /* ft22                                                 */
    *(--p_stk) = (CPU_STK) 0xa2a2a2a2uL;       /* ft22                                                 */
    *(--p_stk) = (CPU_STK) 0xa1a1a1a1uL;       /* ft21                                                 */
    *(--p_stk) = (CPU_STK) 0xa1a1a1a1uL;       /* ft21                                                 */
    *(--p_stk) = (CPU_STK) 0xa0a0a0a0uL;       /* ft20                                                 */
    *(--p_stk) = (CPU_STK) 0xa0a0a0a0uL;       /* ft20                                                 */
    *(--p_stk) = (CPU_STK) 0x99999999uL;       /* ft19                                                 */
    *(--p_stk) = (CPU_STK) 0x99999999uL;       /* ft19                                                 */
    *(--p_stk) = (CPU_STK) 0x98989898uL;       /* ft18                                                 */
    *(--p_stk) = (CPU_STK) 0x98989898uL;       /* ft18                                                 */
    *(--p_stk) = (CPU_STK) 0x97979797uL;       /* ft17                                                 */
    *(--p_stk) = (CPU_STK) 0x97979797uL;       /* ft17                                                 */
    *(--p_stk) = (CPU_STK) 0x96969696uL;       /* ft16                                                 */
    *(--p_stk) = (CPU_STK) 0x96969696uL;       /* ft16                                                 */
    *(--p_stk) = (CPU_STK) 0x95959595uL;       /* ft15                                                 */
    *(--p_stk) = (CPU_STK) 0x95959595uL;       /* ft15                                                 */
    *(--p_stk) = (CPU_STK) 0x94949494uL;       /* ft14                                                 */
    *(--p_stk) = (CPU_STK) 0x94949494uL;       /* ft14                                                 */
    *(--p_stk) = (CPU_STK) 0x93939393uL;       /* ft13                                                 */
    *(--p_stk) = (CPU_STK) 0x93939393uL;       /* ft13                                                 */
    *(--p_stk) = (CPU_STK) 0x92929292uL;       /* ft12                                                 */
    *(--p_stk) = (CPU_STK) 0x92929292uL;       /* ft12                                                 */
    *(--p_stk) = (CPU_STK) 0x91919191uL;       /* ft11                                                 */
    *(--p_stk) = (CPU_STK) 0x91919191uL;       /* ft11                                                 */
    *(--p_stk) = (CPU_STK) 0x90909090uL;       /* ft10                                                 */
    *(--p_stk) = (CPU_STK) 0x90909090uL;       /* ft10                                                 */
    *(--p_stk) = (CPU_STK) 0x89898989uL;       /* ft09                                                 */
    *(--p_stk) = (CPU_STK) 0x89898989uL;       /* ft09                                                 */
    *(--p_stk) = (CPU_STK) 0x88888888uL;       /* ft08                                                 */
    *(--p_stk) = (CPU_STK) 0x88888888uL;       /* ft08                                                 */
    *(--p_stk) = (CPU_STK) 0x87878787uL;       /* ft07                                                 */
    *(--p_stk) = (CPU_STK) 0x87878787uL;       /* ft07                                                 */
    *(--p_stk) = (CPU_STK) 0x86868686uL;       /* ft06                                                 */
    *(--p_stk) = (CPU_STK) 0x86868686uL;       /* ft06                                                 */
    *(--p_stk) = (CPU_STK) 0x85858585uL;       /* ft05                                                 */
    *(--p_stk) = (CPU_STK) 0x85858585uL;       /* ft05                                                 */
    *(--p_stk) = (CPU_STK) 0x84848484uL;       /* ft04                                                 */
    *(--p_stk) = (CPU_STK) 0x84848484uL;       /* ft04                                                 */
    *(--p_stk) = (CPU_STK) 0x83838383uL;       /* ft03                                                 */
    *(--p_stk) = (CPU_STK) 0x83838383uL;       /* ft03                                                 */
    *(--p_stk) = (CPU_STK) 0x82828282uL;       /* ft02                                                 */
    *(--p_stk) = (CPU_STK) 0x82828282uL;       /* ft02                                                 */
    *(--p_stk) = (CPU_STK) 0x81818181uL;       /* ft01                                                 */
    *(--p_stk) = (CPU_STK) 0x81818181uL;       /* ft01                                                 */
    *(--p_stk) = (CPU_STK) 0x80808080uL;       /* ft00                                                 */
    *(--p_stk) = (CPU_STK) 0x80808080uL;       /* ft00                                                 */
    *(--p_stk) = (CPU_STK) OS_TaskReturn;      /* ra: return address                                   */
    *(--p_stk) = (CPU_STK) OS_TaskReturn;      /* ra: return address                                   */
