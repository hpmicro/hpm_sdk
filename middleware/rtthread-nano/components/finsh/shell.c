...
#if defined(__ICCARM__) || defined(__ICCRISCV__) || defined(__ICCRX__)               /* for IAR compiler */
#ifdef FINSH_USING_SYMTAB
...
#elif defined (__ICCARM__) || defined(__ICCRISCV__) || defined(__ICCRX__)     /* for IAR Compiler */
