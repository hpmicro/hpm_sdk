...
#if defined(HPMICRO)	/** HPMICRO target -> uses a struct for the network interface */
...
#if defined(HPMICRO)  /** HPMICRO target, the hostname is linked to the network interface */
/** @ingroup CIP_API
