...
typedef struct i2c_initialize_config {
    i2c_communication_mode_t communication_mode; /* I2C communication mode */
    i2c_speed_t speed;                           /* I2C communication speed */
 ...
 *
 * @param config Pointer to an i2c_initialize_config_t structure where the default initialization settings will be stored.
 *               This structure contains various configuration parameters required for I2C device initialization.
 */
 ...
 * setting it up for communication.
 *
 * @param [in] ptr I2C base address
 * @param [in] config Pointer to the I2C initialization configuration structure, containing settings such as mode and speed
