...
#ifndef HPM_TSW_JL1111_H
#define HPM_TSW_JL1111_H
...
typedef struct {
    ...
    uint8_t media_interface;    /**< Interface type: @ref tsw_port_phy_itf_t */
} jl1111_config_t;
