 ...
 * @defgroup clock_hpm6p80_interface CLOCK driver APIs for HPM6P81
 * @{
 *
 */
...
#define CLK_SRC_GROUP_PMIC    (8U)
#define CLK_SRC_GROUP_PEWDG   (9U)
#define CLK_SRC_GROUP_CPU0    (10U)
#define CLK_SRC_GROUP_CPU1    (11U)
#define CLK_SRC_GROUP_SRC     (12U)
#define CLK_SRC_GROUP_INVALID (13U)
...
typedef enum _clock_sources {
    ...
    clk_adc_src_ana2 = MAKE_CLK_SRC(CLK_SRC_GROUP_ADC, 1),
    clk_adc_src_ana3 = MAKE_CLK_SRC(CLK_SRC_GROUP_ADC, 1),
    ...
    clk_dac_src_ahb0 = MAKE_CLK_SRC(CLK_SRC_GROUP_AHB, 0),
...
typedef enum _clock_name {
    ...
    clock_dac0 = MAKE_CLOCK_NAME(sysctl_resource_dac0, CLK_SRC_GROUP_AHB, 0),
    clock_dac1 = MAKE_CLOCK_NAME(sysctl_resource_dac1, CLK_SRC_GROUP_AHB, 0),
