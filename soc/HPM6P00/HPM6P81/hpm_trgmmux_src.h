...
#define HPM_TRGM0_INPUT_SRC_ENET0_PTP3                     (0x3UL)   /* PTP output bit 3 of ENET0 */
...
#define HPM_TRGM0_INPUT_SRC_PWM3_CAPIN0                    (0x16UL)  /* PWM3 Input 0 (from IO) */
#define HPM_TRGM0_INPUT_SRC_PWM3_CAPIN1                    (0x17UL)  /* PWM3 Input 1 (from IO) */
...
#define HPM_TRGM0_INPUT_SRC_ADC3_TRGO                      (0x47UL)  /* ADC3 triggers output */
...
#define HPM_TRGM0_INPUT_SRC_PWM3_TRGO_0                    (0x60UL)  /* PWM3 triggers output0 */
#define HPM_TRGM0_INPUT_SRC_PWM3_TRGO_1                    (0x61UL)  /* PWM3 triggers output1 */
#define HPM_TRGM0_INPUT_SRC_PWM3_TRGO_2                    (0x62UL)  /* PWM3 triggers output2 */
#define HPM_TRGM0_INPUT_SRC_PWM3_TRGO_3                    (0x63UL)  /* PWM3 triggers output3 */
#define HPM_TRGM0_INPUT_SRC_PWM3_TRGO_4                    (0x64UL)  /* PWM3 triggers output4 */
#define HPM_TRGM0_INPUT_SRC_PWM3_TRGO_5                    (0x65UL)  /* PWM3 triggers output5 */
#define HPM_TRGM0_INPUT_SRC_PWM3_TRGO_6                    (0x66UL)  /* PWM3 triggers output6 */
#define HPM_TRGM0_INPUT_SRC_PWM3_TRGO_7                    (0x67UL)  /* PWM3 triggers output7 */
...
#define HPM_TRGM0_OUTPUT_SRC_ADC3_STRGI                    (0x33UL)  /* The sequence conversion of ADC3 triggers input */
...
#define HPM_TRGM0_OUTPUT_SRC_PWM3_TRIG_IN0                 (0xC2UL)  /* PWM3 triggers input 0 */
#define HPM_TRGM0_OUTPUT_SRC_PWM3_TRIG_IN1                 (0xC3UL)  /* PWM3 triggers input 1 */
#define HPM_TRGM0_OUTPUT_SRC_PWM3_TRIG_IN2                 (0xC4UL)  /* PWM3 triggers input 2 */
#define HPM_TRGM0_OUTPUT_SRC_PWM3_TRIG_IN3                 (0xC5UL)  /* PWM3 triggers input 3 */
#define HPM_TRGM0_OUTPUT_SRC_PWM3_TRIG_IN4                 (0xC6UL)  /* PWM3 triggers input 4 */
#define HPM_TRGM0_OUTPUT_SRC_PWM3_TRIG_IN5                 (0xC7UL)  /* PWM3 triggers input 5 */
#define HPM_TRGM0_OUTPUT_SRC_PWM3_TRIG_IN6                 (0xC8UL)  /* PWM3 triggers input 6 */
#define HPM_TRGM0_OUTPUT_SRC_PWM3_TRIG_IN7                 (0xC9UL)  /* PWM3 triggers input 7 */
...
#define HPM_TRGM0_FILTER_SRC_PWM3_IN0                      (0x18UL)  /* PWM timer 3 capture Input 0 */
#define HPM_TRGM0_FILTER_SRC_PWM3_IN1                      (0x19UL)  /* PWM timer 3 capture Input 1 */
#define HPM_TRGM0_FILTER_SRC_PWM3_IN2                      (0x1AUL)  /* PWM timer 3 capture Input 2 */
#define HPM_TRGM0_FILTER_SRC_PWM3_IN3                      (0x1BUL)  /* PWM timer 3 capture Input 3 */
#define HPM_TRGM0_FILTER_SRC_PWM3_IN4                      (0x1CUL)  /* PWM timer 3 capture Input 4 */
#define HPM_TRGM0_FILTER_SRC_PWM3_IN5                      (0x1DUL)  /* PWM timer 3 capture Input 5 */
#define HPM_TRGM0_FILTER_SRC_PWM3_IN6                      (0x1EUL)  /* PWM timer 3 capture Input 6 */
#define HPM_TRGM0_FILTER_SRC_PWM3_IN7                      (0x1FUL)  /* PWM timer 3 capture Input 7 */
...
#define HPM_TRGM0_DMA_SRC_PWM3_REQ0                        (0xCUL)   /* DMA request 0 for PWM3 */
#define HPM_TRGM0_DMA_SRC_PWM3_REQ1                        (0xDUL)   /* DMA request 1 for PWM3 */
#define HPM_TRGM0_DMA_SRC_PWM3_REQ2                        (0xEUL)   /* DMA request 2 for PWM3 */
#define HPM_TRGM0_DMA_SRC_PWM3_REQ3                        (0xFUL)   /* DMA request 3 for PWM3 */
