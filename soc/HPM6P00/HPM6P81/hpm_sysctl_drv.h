 ...
 * @defgroup sysctl_hpm6p81_interface SYSCTL driver APIs for HPM6P81
...
typedef enum {
    ...
    sysctl_resource_clk_top_ntmr0 = SYSCTL_RESOURCE_CLK_TOP_NTM0,
...
typedef enum {
    ...
    monitor_target_clk_top_ahb = 135,
    monitor_target_clk_top_gptmr0 = 136,
    monitor_target_clk_top_gptmr1 = 137,
    monitor_target_clk_top_gptmr2 = 138,
    monitor_target_clk_top_gptmr3 = 139,
    ...
    monitor_target_clk_top_femc = 161,
    ...
    monitor_target_clk_top_ana2 = 169,
    monitor_target_clk_top_ana3 = 170,
    monitor_target_clk_top_aud0 = 171,
    monitor_target_clk_top_aud1 = 172,
} monitor_target_t;
...
/**
 * @brief Get CPU1 resource retention
 *
 * @param[in] ptr SYSCTL_Type base address
 * @return retention value
 */
static inline uint32_t sysctl_get_cpu1_lp_retention(SYSCTL_Type *ptr)
{
    return sysctl_get_cpu_lp_retention(ptr, 1);
}
