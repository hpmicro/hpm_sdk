...
typedef struct {
    ...
    __R  uint8_t  RESERVED8[4];                /* 0x21C - 0x21F: Reserved */
    __RW uint32_t CAL_CFG;                     /* 0x220: cal_cfg */
    __R  uint8_t  RESERVED9[12];               /* 0x224 - 0x22F: Reserved */
    __RW uint32_t PHASE_PARAM;                 /* 0x230: phase_param */
    __R  uint8_t  RESERVED10[4];               /* 0x234 - 0x237: Reserved */
    __RW uint32_t POS_THRESHOLD;               /* 0x238: pos_threshold */
    __R  uint8_t  RESERVED11[4];               /* 0x23C - 0x23F: Reserved */
    __RW uint32_t UVW_POS[6];                  /* 0x240 - 0x254: uvw_pos0 */
    __RW uint32_t UVW_POS_CFG[6];              /* 0x258 - 0x26C: uvw_pos0_cfg */
    __R  uint8_t  RESERVED12[16];              /* 0x270 - 0x27F: Reserved */
    ...
    __R  uint8_t  RESERVED13[40];              /* 0x298 - 0x2BF: Reserved */
    __RW uint32_t TOGI_CFG0;                   /* 0x2C0: togi_cfg0 */
    __RW uint32_t TOGI_CFG1;                   /* 0x2C4: togi_cfg1 */
    __R  uint8_t  RESERVED14[8];               /* 0x2C8 - 0x2CF: Reserved */
