 ...
 * DAC_TRIG_EN (RW)
 *
 * if set, the dac value is from moto system when valid
 * if clr, use dac_cfg value
 */
 ...
 * DACCFG (RW)
 *
 * 12bit DAC digital value.
 * Note: The value must not exceed 0xFF0
 */
#define ACMP_CHANNEL_DACCFG_DACCFG_MASK (0xFFF0U)
#define ACMP_CHANNEL_DACCFG_DACCFG_SHIFT (4U)
