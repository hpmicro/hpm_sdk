 ...
 * FRC_ALIGN_FBUF (RW)
 *
 * Asserted to make the buffer always frame aligned even in case of buffer underflow or overflow
 */
#define I2S_CTRL_FRC_ALIGN_FBUF_MASK (0x80000UL)
#define I2S_CTRL_FRC_ALIGN_FBUF_SHIFT (19U)
#define I2S_CTRL_FRC_ALIGN_FBUF_SET(x) (((uint32_t)(x) << I2S_CTRL_FRC_ALIGN_FBUF_SHIFT) & I2S_CTRL_FRC_ALIGN_FBUF_MASK)
#define I2S_CTRL_FRC_ALIGN_FBUF_GET(x) (((uint32_t)(x) & I2S_CTRL_FRC_ALIGN_FBUF_MASK) >> I2S_CTRL_FRC_ALIGN_FBUF_SHIFT)
