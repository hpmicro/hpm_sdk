...
typedef struct {
    struct {
        ...
        __RW uint32_t LIND;                    /* 0xD8:  inductance used in decoupling */
        __RW uint32_t KE;                      /* 0xDC:  Ke used in decoupling */
        __RW uint32_t ADC_SW;                  /* 0xE0:  adc software inject value */
        __RW uint32_t SPEED_SW;                /* 0xE4:  speed software inject value */
        __RW uint32_t DECOUPLE_SCALING;        /* 0xE8:  decoupling scaling ratio */
...
/* Bitfield definition for register of struct array VDVQ_CHAN: LIND */
/*
 * LIND (RW)
 *
 * VD/VQ inductance used in decoupling
 */
...
/* Bitfield definition for register of struct array VDVQ_CHAN: KE */
/*
 * KE (RW)
 *
 * VD/VQ inductance used in decoupling
...
/* Bitfield definition for register of struct array VDVQ_CHAN: SPEED_SW */
/*
 * SPEED_SW (RW)
 *
 * speed software inject value
 */
...
/* Bitfield definition for register of struct array VDVQ_CHAN: DECOUPLE_SCALING */
/*
 * DECOUPLE_SCALING (RW)
 *
 * decoupling scaling ratio
 */
