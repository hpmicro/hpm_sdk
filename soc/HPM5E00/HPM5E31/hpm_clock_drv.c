...
#define FREQ_PRESET1_PLL0_CLK1 (375000000UL)
#define FREQ_PRESET1_PLL1_CLK0 (400000000UL)
#define FREQ_PRESET1_PLL1_CLK1 (333333333UL)
#define FREQ_PRESET1_PLL1_CLK2 (266666666UL)
#define FREQ_PRESET1_PLL2_CLK0 (500000000UL)
#define FREQ_PRESET1_PLL2_CLK1 (250000000UL)
#define FREQ_32KHz (32768UL)
#define ADC_INSTANCE_NUM ARRAY_SIZE(HPM_SYSCTL->ADCCLK)
#define EWDG_INSTANCE_NUM (2U)
