 ...
 * @defgroup sysctl_hpm5e31_interface SYSCTL driver APIs for HPM5E31
...
typedef enum {
    ...
    sysctl_resource_pmic = SYSCTL_RESOURCE_PMIC,
    ...
    sysctl_resource_clk_top_owire0 = SYSCTL_RESOURCE_CLK_TOP_OWR0,
    sysctl_resource_clk_top_owire1 = SYSCTL_RESOURCE_CLK_TOP_OWR1,
    ...
    sysctl_resource_clk_top_esc0 = SYSCTL_RESOURCE_CLK_TOP_ESC0,
    ...
    sysctl_resource_owire0 = SYSCTL_RESOURCE_OWR0,
    sysctl_resource_owire1 = SYSCTL_RESOURCE_OWR1,
    sysctl_resource_eui0 = SYSCTL_RESOURCE_EUI0,
    sysctl_resource_eui1 = SYSCTL_RESOURCE_EUI1,
...
typedef enum {
    ...
    clock_node_owire0 = SYSCTL_CLOCK_CLK_TOP_OWR0,
    clock_node_owire1 = SYSCTL_CLOCK_CLK_TOP_OWR1,
    ...
    clock_node_esc0 = SYSCTL_CLOCK_CLK_TOP_ESC0,
...
typedef enum {
    ...
    monitor_target_clk_top_axif = 130,
    monitor_target_clk_top_axis = 131,
    monitor_target_clk_top_axic = 132,
    monitor_target_clk_top_ahb0 = 133,
    monitor_target_clk_top_gptmr0 = 134,
    monitor_target_clk_top_gptmr1 = 135,
    monitor_target_clk_top_gptmr2 = 136,
    monitor_target_clk_top_gptmr3 = 137,
    monitor_target_clk_top_owire0 = 138,
    monitor_target_clk_top_owire1 = 139,
    monitor_target_clk_top_i2c0 = 140,
    monitor_target_clk_top_i2c1 = 141,
    monitor_target_clk_top_i2c2 = 142,
    monitor_target_clk_top_i2c3 = 143,
    monitor_target_clk_top_spi0 = 144,
    monitor_target_clk_top_spi1 = 145,
    monitor_target_clk_top_spi2 = 146,
    monitor_target_clk_top_spi3 = 147,
    monitor_target_clk_top_uart0 = 148,
    monitor_target_clk_top_uart1 = 149,
    monitor_target_clk_top_uart2 = 150,
    monitor_target_clk_top_uart3 = 151,
    monitor_target_clk_top_uart4 = 152,
    monitor_target_clk_top_uart5 = 153,
    monitor_target_clk_top_uart6 = 154,
    monitor_target_clk_top_uart7 = 155,
    monitor_target_clk_top_can0 = 156,
    monitor_target_clk_top_can1 = 157,
    monitor_target_clk_top_can2 = 158,
    monitor_target_clk_top_can3 = 159,
    monitor_target_clk_top_xpi0 = 160,
    monitor_target_clk_top_esc0 = 161,
    monitor_target_clk_top_eth0 = 162,
    monitor_target_clk_top_ptp0 = 163,
    monitor_target_clk_top_ref0 = 164,
    monitor_target_clk_top_ref1 = 165,
    monitor_target_clk_top_ntmr0 = 166,
    monitor_target_clk_top_ana0 = 167,
    monitor_target_clk_top_ana1 = 168,
} monitor_target_t;
