...
enum {
    ...
    status_clk_fixed = MAKE_STATUS(status_group_clk, 9),
};
...
#define CLK_SRC_GROUP_EWDG    (2U)
#define CLK_SRC_GROUP_AHB     (3U)
#define CLK_SRC_GROUP_AXIF    (4U)
#define CLK_SRC_GROUP_AXIS    (5U)
#define CLK_SRC_GROUP_AXIC    (6U)
#define CLK_SRC_GROUP_PMIC    (7U)
#define CLK_SRC_GROUP_PEWDG   (8U)
#define CLK_SRC_GROUP_CPU0    (9U)
#define CLK_SRC_GROUP_SRC     (10U)
#define CLK_SRC_GROUP_INVALID (11U)
...
typedef enum _clock_sources {
    ...
    clk_adc_src_anan = MAKE_CLK_SRC(CLK_SRC_GROUP_ADC, 1),
...
typedef enum _clock_name {
    ...
    clock_owire0 = MAKE_CLOCK_NAME(sysctl_resource_owire0, CLK_SRC_GROUP_COMMON, clock_node_owire0),
    clock_owire1 = MAKE_CLOCK_NAME(sysctl_resource_owire1, CLK_SRC_GROUP_COMMON, clock_node_owire1),
    ...
    clock_esc0 = MAKE_CLOCK_NAME(sysctl_resource_esc0, CLK_SRC_GROUP_COMMON, clock_node_esc0),
    ...
    clock_eui0 = MAKE_CLOCK_NAME(sysctl_resource_eui0, CLK_SRC_GROUP_AHB, 0),
    clock_eui1 = MAKE_CLOCK_NAME(sysctl_resource_eui1, CLK_SRC_GROUP_AHB, 0),
