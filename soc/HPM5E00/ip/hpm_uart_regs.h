 ...
 * LSR_ERRF_STS (W1C)
 *
 * Receiving FIFO error status，when occurs parity error、framing error or break error,it will generatei;write 1 clear to 0
 */
#define UART_IIR2_LSR_ERRF_STS_MASK (0x4000000UL)
#define UART_IIR2_LSR_ERRF_STS_SHIFT (26U)
#define UART_IIR2_LSR_ERRF_STS_SET(x) (((uint32_t)(x) << UART_IIR2_LSR_ERRF_STS_SHIFT) & UART_IIR2_LSR_ERRF_STS_MASK)
#define UART_IIR2_LSR_ERRF_STS_GET(x) (((uint32_t)(x) & UART_IIR2_LSR_ERRF_STS_MASK) >> UART_IIR2_LSR_ERRF_STS_SHIFT)

/*
 * LSR_BREAK_STS (W1C)
 *
 * Transmission break status, when occurs break error,it will generate;write 1 clear 0
 */
#define UART_IIR2_LSR_BREAK_STS_MASK (0x2000000UL)
#define UART_IIR2_LSR_BREAK_STS_SHIFT (25U)
#define UART_IIR2_LSR_BREAK_STS_SET(x) (((uint32_t)(x) << UART_IIR2_LSR_BREAK_STS_SHIFT) & UART_IIR2_LSR_BREAK_STS_MASK)
#define UART_IIR2_LSR_BREAK_STS_GET(x) (((uint32_t)(x) & UART_IIR2_LSR_BREAK_STS_MASK) >> UART_IIR2_LSR_BREAK_STS_SHIFT)

/*
 * LSR_FRAMING_STS (W1C)
 *
 * Framing error status,when occurs frame error,it will generate;write 1 clear 0
 */
#define UART_IIR2_LSR_FRAMING_STS_MASK (0x1000000UL)
#define UART_IIR2_LSR_FRAMING_STS_SHIFT (24U)
#define UART_IIR2_LSR_FRAMING_STS_SET(x) (((uint32_t)(x) << UART_IIR2_LSR_FRAMING_STS_SHIFT) & UART_IIR2_LSR_FRAMING_STS_MASK)
#define UART_IIR2_LSR_FRAMING_STS_GET(x) (((uint32_t)(x) & UART_IIR2_LSR_FRAMING_STS_MASK) >> UART_IIR2_LSR_FRAMING_STS_SHIFT)

/*
 * LSR_PARITY_STS (W1C)
 *
 * Parity error status,when occurs parity error ,it will generate;write 1 clear 0
 */
#define UART_IIR2_LSR_PARITY_STS_MASK (0x800000UL)
#define UART_IIR2_LSR_PARITY_STS_SHIFT (23U)
#define UART_IIR2_LSR_PARITY_STS_SET(x) (((uint32_t)(x) << UART_IIR2_LSR_PARITY_STS_SHIFT) & UART_IIR2_LSR_PARITY_STS_MASK)
#define UART_IIR2_LSR_PARITY_STS_GET(x) (((uint32_t)(x) & UART_IIR2_LSR_PARITY_STS_MASK) >> UART_IIR2_LSR_PARITY_STS_SHIFT)

/*
 * LSR_OVERRUN_STS (W1C)
 *
 * Receive data overload status;when occurs overrun error ,it will generate;write 1 clear 0
 */
#define UART_IIR2_LSR_OVERRUN_STS_MASK (0x400000UL)
#define UART_IIR2_LSR_OVERRUN_STS_SHIFT (22U)
#define UART_IIR2_LSR_OVERRUN_STS_SET(x) (((uint32_t)(x) << UART_IIR2_LSR_OVERRUN_STS_SHIFT) & UART_IIR2_LSR_OVERRUN_STS_MASK)
#define UART_IIR2_LSR_OVERRUN_STS_GET(x) (((uint32_t)(x) & UART_IIR2_LSR_OVERRUN_STS_MASK) >> UART_IIR2_LSR_OVERRUN_STS_SHIFT)
 ...
 * DMA_STOP_EN (RW)
 *
 * enable dma stopped function
 */
#define UART_FCRR_DMA_STOP_EN_MASK (0x80000000UL)
#define UART_FCRR_DMA_STOP_EN_SHIFT (31U)
#define UART_FCRR_DMA_STOP_EN_SET(x) (((uint32_t)(x) << UART_FCRR_DMA_STOP_EN_SHIFT) & UART_FCRR_DMA_STOP_EN_MASK)
#define UART_FCRR_DMA_STOP_EN_GET(x) (((uint32_t)(x) & UART_FCRR_DMA_STOP_EN_MASK) >> UART_FCRR_DMA_STOP_EN_SHIFT)

/*
 * DMA_STOPPED_WRITE_CLEAR (WO)
 *
 * dma stopped function by writing 1 clear 0
 */
#define UART_FCRR_DMA_STOPPED_WRITE_CLEAR_MASK (0x40000000UL)
#define UART_FCRR_DMA_STOPPED_WRITE_CLEAR_SHIFT (30U)
#define UART_FCRR_DMA_STOPPED_WRITE_CLEAR_SET(x) (((uint32_t)(x) << UART_FCRR_DMA_STOPPED_WRITE_CLEAR_SHIFT) & UART_FCRR_DMA_STOPPED_WRITE_CLEAR_MASK)
#define UART_FCRR_DMA_STOPPED_WRITE_CLEAR_GET(x) (((uint32_t)(x) & UART_FCRR_DMA_STOPPED_WRITE_CLEAR_MASK) >> UART_FCRR_DMA_STOPPED_WRITE_CLEAR_SHIFT)

/*
 * BAUD_ACT_ENJ_PCLK (RW)
 *
 * Set the value of the configuration object.
 */
#define UART_FCRR_BAUD_ACT_ENJ_PCLK_MASK (0x2000000UL)
#define UART_FCRR_BAUD_ACT_ENJ_PCLK_SHIFT (25U)
#define UART_FCRR_BAUD_ACT_ENJ_PCLK_SET(x) (((uint32_t)(x) << UART_FCRR_BAUD_ACT_ENJ_PCLK_SHIFT) & UART_FCRR_BAUD_ACT_ENJ_PCLK_MASK)
#define UART_FCRR_BAUD_ACT_ENJ_PCLK_GET(x) (((uint32_t)(x) & UART_FCRR_BAUD_ACT_ENJ_PCLK_MASK) >> UART_FCRR_BAUD_ACT_ENJ_PCLK_SHIFT)
 ...
 * TXSTOP_OPT (RW)
 *
 * set to use baud_mx as txstop_bits counter, for control DE delay after STOP
 */
#define UART_MOTO_CFG_TXSTOP_OPT_MASK (0x1000000UL)
#define UART_MOTO_CFG_TXSTOP_OPT_SHIFT (24U)
#define UART_MOTO_CFG_TXSTOP_OPT_SET(x) (((uint32_t)(x) << UART_MOTO_CFG_TXSTOP_OPT_SHIFT) & UART_MOTO_CFG_TXSTOP_OPT_MASK)
#define UART_MOTO_CFG_TXSTOP_OPT_GET(x) (((uint32_t)(x) & UART_MOTO_CFG_TXSTOP_OPT_MASK) >> UART_MOTO_CFG_TXSTOP_OPT_SHIFT)

/*
 * TXPRE_DLY (RW)
 *
 * if set to none-zero value, will assert DE before START bit, with the unit of clock dividered after dll/dlm
 */
#define UART_MOTO_CFG_TXPRE_DLY_MASK (0xFF0000UL)
#define UART_MOTO_CFG_TXPRE_DLY_SHIFT (16U)
#define UART_MOTO_CFG_TXPRE_DLY_SET(x) (((uint32_t)(x) << UART_MOTO_CFG_TXPRE_DLY_SHIFT) & UART_MOTO_CFG_TXPRE_DLY_MASK)
#define UART_MOTO_CFG_TXPRE_DLY_GET(x) (((uint32_t)(x) & UART_MOTO_CFG_TXPRE_DLY_MASK) >> UART_MOTO_CFG_TXPRE_DLY_SHIFT)
 ...
 * RX_BREAK_ERR (RO)
 *
 * can see if a break error occurs per byte of data(including intermediate state)
 */
#define UART_RBR_RX_BREAK_ERR_MASK (0x400U)
#define UART_RBR_RX_BREAK_ERR_SHIFT (10U)
#define UART_RBR_RX_BREAK_ERR_GET(x) (((uint32_t)(x) & UART_RBR_RX_BREAK_ERR_MASK) >> UART_RBR_RX_BREAK_ERR_SHIFT)

/*
 * FRAMING_ERR (RO)
 *
 * can see if a framing error occurs per byte of data(including intermediate state)
 */
#define UART_RBR_FRAMING_ERR_MASK (0x200U)
#define UART_RBR_FRAMING_ERR_SHIFT (9U)
#define UART_RBR_FRAMING_ERR_GET(x) (((uint32_t)(x) & UART_RBR_FRAMING_ERR_MASK) >> UART_RBR_FRAMING_ERR_SHIFT)

/*
 * PARITY_ERR (RO)
 *
 * can see if a  parity error occurs per byte of data(including intermediate state)
 */
#define UART_RBR_PARITY_ERR_MASK (0x100U)
#define UART_RBR_PARITY_ERR_SHIFT (8U)
#define UART_RBR_PARITY_ERR_GET(x) (((uint32_t)(x) & UART_RBR_PARITY_ERR_MASK) >> UART_RBR_PARITY_ERR_SHIFT)
 ...
 * LSR_ERRF_IRQ_EN (RW)
 *
 * enable transmission error interrupt
 */
#define UART_IER_LSR_ERRF_IRQ_EN_MASK (0x4000000UL)
#define UART_IER_LSR_ERRF_IRQ_EN_SHIFT (26U)
#define UART_IER_LSR_ERRF_IRQ_EN_SET(x) (((uint32_t)(x) << UART_IER_LSR_ERRF_IRQ_EN_SHIFT) & UART_IER_LSR_ERRF_IRQ_EN_MASK)
#define UART_IER_LSR_ERRF_IRQ_EN_GET(x) (((uint32_t)(x) & UART_IER_LSR_ERRF_IRQ_EN_MASK) >> UART_IER_LSR_ERRF_IRQ_EN_SHIFT)
 ...
 */
#define UART_IER_LSR_BREAK_IRQ_EN_MASK (0x2000000UL)
#define UART_IER_LSR_BREAK_IRQ_EN_SHIFT (25U)
#define UART_IER_LSR_BREAK_IRQ_EN_SET(x) (((uint32_t)(x) << UART_IER_LSR_BREAK_IRQ_EN_SHIFT) & UART_IER_LSR_BREAK_IRQ_EN_MASK)
#define UART_IER_LSR_BREAK_IRQ_EN_GET(x) (((uint32_t)(x) & UART_IER_LSR_BREAK_IRQ_EN_MASK) >> UART_IER_LSR_BREAK_IRQ_EN_SHIFT)

/*
 * LSR_FRAMING_IRQ_EN (RW)
 *
 * enable framing error interrupt
 */
#define UART_IER_LSR_FRAMING_IRQ_EN_MASK (0x1000000UL)
#define UART_IER_LSR_FRAMING_IRQ_EN_SHIFT (24U)
#define UART_IER_LSR_FRAMING_IRQ_EN_SET(x) (((uint32_t)(x) << UART_IER_LSR_FRAMING_IRQ_EN_SHIFT) & UART_IER_LSR_FRAMING_IRQ_EN_MASK)
#define UART_IER_LSR_FRAMING_IRQ_EN_GET(x) (((uint32_t)(x) & UART_IER_LSR_FRAMING_IRQ_EN_MASK) >> UART_IER_LSR_FRAMING_IRQ_EN_SHIFT)

/*
 * LSR_PARITY_IRQ_EN (RW)
 *
 * enable parity error interrupt
 */
#define UART_IER_LSR_PARITY_IRQ_EN_MASK (0x800000UL)
#define UART_IER_LSR_PARITY_IRQ_EN_SHIFT (23U)
#define UART_IER_LSR_PARITY_IRQ_EN_SET(x) (((uint32_t)(x) << UART_IER_LSR_PARITY_IRQ_EN_SHIFT) & UART_IER_LSR_PARITY_IRQ_EN_MASK)
#define UART_IER_LSR_PARITY_IRQ_EN_GET(x) (((uint32_t)(x) & UART_IER_LSR_PARITY_IRQ_EN_MASK) >> UART_IER_LSR_PARITY_IRQ_EN_SHIFT)

/*
 * LSR_OVERRUN_IRQ_EN (RW)
 *
 * enable data overload interrupt
 */
#define UART_IER_LSR_OVERRUN_IRQ_EN_MASK (0x400000UL)
#define UART_IER_LSR_OVERRUN_IRQ_EN_SHIFT (22U)
#define UART_IER_LSR_OVERRUN_IRQ_EN_SET(x) (((uint32_t)(x) << UART_IER_LSR_OVERRUN_IRQ_EN_SHIFT) & UART_IER_LSR_OVERRUN_IRQ_EN_MASK)
#define UART_IER_LSR_OVERRUN_IRQ_EN_GET(x) (((uint32_t)(x) & UART_IER_LSR_OVERRUN_IRQ_EN_MASK) >> UART_IER_LSR_OVERRUN_IRQ_EN_SHIFT)
