...
typedef struct {
    ...
    __R  uint8_t  RESERVED5[192];              /* 0x1040 - 0x10FF: Reserved */
    __RW uint32_t CONV_CFG0;                   /* 0x1100:  */
    ...
    __RW uint32_t TRIGMUX_EN;                  /* 0x1118:  */
    __RW uint32_t TRG_CMPT_FLAG;               /* 0x111C:  */
    __R  uint8_t  RESERVED7[224];              /* 0x1120 - 0x11FF: Reserved */
...
/* Bitfield definition for register: CONV_CFG0 */
/*
 * FULL_RESOLUTION (RW)
 *
 * in differential mode, if result is less than 0, then output 0;
 */
#define ADC16_CONV_CFG0_FULL_RESOLUTION_MASK (0x8U)
#define ADC16_CONV_CFG0_FULL_RESOLUTION_SHIFT (3U)
#define ADC16_CONV_CFG0_FULL_RESOLUTION_SET(x) (((uint32_t)(x) << ADC16_CONV_CFG0_FULL_RESOLUTION_SHIFT) & ADC16_CONV_CFG0_FULL_RESOLUTION_MASK)
#define ADC16_CONV_CFG0_FULL_RESOLUTION_GET(x) (((uint32_t)(x) & ADC16_CONV_CFG0_FULL_RESOLUTION_MASK) >> ADC16_CONV_CFG0_FULL_RESOLUTION_SHIFT)

/*
 * POS_MODE (RW)
 *
 * 0:  result is from -32768 to +32767(result 0 if two adc results are same );
 * 1:  result is from 0 to 65535 (result 32768 if two adc results are same );
 */
#define ADC16_CONV_CFG0_POS_MODE_MASK (0x4U)
#define ADC16_CONV_CFG0_POS_MODE_SHIFT (2U)
#define ADC16_CONV_CFG0_POS_MODE_SET(x) (((uint32_t)(x) << ADC16_CONV_CFG0_POS_MODE_SHIFT) & ADC16_CONV_CFG0_POS_MODE_MASK)
#define ADC16_CONV_CFG0_POS_MODE_GET(x) (((uint32_t)(x) & ADC16_CONV_CFG0_POS_MODE_MASK) >> ADC16_CONV_CFG0_POS_MODE_SHIFT)

/*
 * DIFF_MASTER (RW)
 *
 * set to act as master, will use the result of current adc minus another adc result as final result.
 * Refer to soc UM for which is the another adc.
 */
#define ADC16_CONV_CFG0_DIFF_MASTER_MASK (0x2U)
#define ADC16_CONV_CFG0_DIFF_MASTER_SHIFT (1U)
#define ADC16_CONV_CFG0_DIFF_MASTER_SET(x) (((uint32_t)(x) << ADC16_CONV_CFG0_DIFF_MASTER_SHIFT) & ADC16_CONV_CFG0_DIFF_MASTER_MASK)
#define ADC16_CONV_CFG0_DIFF_MASTER_GET(x) (((uint32_t)(x) & ADC16_CONV_CFG0_DIFF_MASTER_MASK) >> ADC16_CONV_CFG0_DIFF_MASTER_SHIFT)

/*
 * ADC_DIFF_MODE (RW)
 *
 * set to enable differential mode
 */
#define ADC16_CONV_CFG0_ADC_DIFF_MODE_MASK (0x1U)
#define ADC16_CONV_CFG0_ADC_DIFF_MODE_SHIFT (0U)
#define ADC16_CONV_CFG0_ADC_DIFF_MODE_SET(x) (((uint32_t)(x) << ADC16_CONV_CFG0_ADC_DIFF_MODE_SHIFT) & ADC16_CONV_CFG0_ADC_DIFF_MODE_MASK)
#define ADC16_CONV_CFG0_ADC_DIFF_MODE_GET(x) (((uint32_t)(x) & ADC16_CONV_CFG0_ADC_DIFF_MODE_MASK) >> ADC16_CONV_CFG0_ADC_DIFF_MODE_SHIFT)
...
/* Bitfield definition for register: TRIGMUX_EN */
/*
 * SEQ_CMPT (RW)
 *
 */
...
/* Bitfield definition for register: TRG_CMPT_FLAG */
/*
 * TRG_CMPT_FLAG (RW1C)
 *
 */
