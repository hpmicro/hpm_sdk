...
typedef struct {
    struct {
        ...
        __RW uint32_t FILTER;                  /* 0x88: wave input position filter */
    } WAVE;
    __R  uint8_t  RESERVED0[116];              /* 0x8C - 0xFF: Reserved */
    struct {
        ...
        __RW uint32_t FILTER;                  /* 0x134: abz input position filter */
    } ABZ;
    __R  uint8_t  RESERVED1[8];                /* 0x138 - 0x13F: Reserved */
    struct {
        ...
        __RW uint32_t FILTER;                  /* 0x1B8: pwm input position filter */
    } PWM;
    __R  uint8_t  RESERVED2[60];               /* 0x1BC - 0x1F7: Reserved */
...
/* Bitfield definition for register of struct WAVE: FILTER */
/*
 * VAL (RW)
 *
 * wave_filter
 */
#define QEOV2_WAVE_FILTER_VAL_MASK (0xFFFFFFFFUL)
#define QEOV2_WAVE_FILTER_VAL_SHIFT (0U)
#define QEOV2_WAVE_FILTER_VAL_SET(x) (((uint32_t)(x) << QEOV2_WAVE_FILTER_VAL_SHIFT) & QEOV2_WAVE_FILTER_VAL_MASK)
#define QEOV2_WAVE_FILTER_VAL_GET(x) (((uint32_t)(x) & QEOV2_WAVE_FILTER_VAL_MASK) >> QEOV2_WAVE_FILTER_VAL_SHIFT)
...
/* Bitfield definition for register of struct ABZ: FILTER */
/*
 * VAL (RW)
 *
 * abz_filter
 */
#define QEOV2_ABZ_FILTER_VAL_MASK (0xFFFFFFFFUL)
#define QEOV2_ABZ_FILTER_VAL_SHIFT (0U)
#define QEOV2_ABZ_FILTER_VAL_SET(x) (((uint32_t)(x) << QEOV2_ABZ_FILTER_VAL_SHIFT) & QEOV2_ABZ_FILTER_VAL_MASK)
#define QEOV2_ABZ_FILTER_VAL_GET(x) (((uint32_t)(x) & QEOV2_ABZ_FILTER_VAL_MASK) >> QEOV2_ABZ_FILTER_VAL_SHIFT)
...
/* Bitfield definition for register of struct PWM: FILTER */
/*
 * VAL (RW)
 *
 * pwm_filter
 */
#define QEOV2_PWM_FILTER_VAL_MASK (0xFFFFFFFFUL)
#define QEOV2_PWM_FILTER_VAL_SHIFT (0U)
#define QEOV2_PWM_FILTER_VAL_SET(x) (((uint32_t)(x) << QEOV2_PWM_FILTER_VAL_SHIFT) & QEOV2_PWM_FILTER_VAL_MASK)
#define QEOV2_PWM_FILTER_VAL_GET(x) (((uint32_t)(x) & QEOV2_PWM_FILTER_VAL_MASK) >> QEOV2_PWM_FILTER_VAL_SHIFT)
