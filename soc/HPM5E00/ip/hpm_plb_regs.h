...
typedef struct {
    ...
    struct {
        ...
        __RW uint32_t LUT_CMP[4];              /* 0x420 - 0x42C: TYPE B CHN cmp0 lut */
        __R  uint8_t  RESERVED0[80];           /* 0x430 - 0x47F: Reserved */
    } TYPE_B[8];
} PLB_Type;
 ...
 * LUT_CMP (RW)
 *
 * using 4 bit trig_in as lookup index. software can program this register as cmp load control's true table.
 */
#define PLB_TYPE_B_LUT_CMP_LUT_CMP_MASK (0xFFFFU)
#define PLB_TYPE_B_LUT_CMP_LUT_CMP_SHIFT (0U)
#define PLB_TYPE_B_LUT_CMP_LUT_CMP_SET(x) (((uint32_t)(x) << PLB_TYPE_B_LUT_CMP_LUT_CMP_SHIFT) & PLB_TYPE_B_LUT_CMP_LUT_CMP_MASK)
#define PLB_TYPE_B_LUT_CMP_LUT_CMP_GET(x) (((uint32_t)(x) & PLB_TYPE_B_LUT_CMP_LUT_CMP_MASK) >> PLB_TYPE_B_LUT_CMP_LUT_CMP_SHIFT)
...
/* LUT_CMP register group index macro definition */
#define PLB_TYPE_B_LUT_CMP_0 (0UL)
#define PLB_TYPE_B_LUT_CMP_1 (1UL)
#define PLB_TYPE_B_LUT_CMP_2 (2UL)
#define PLB_TYPE_B_LUT_CMP_3 (3UL)
