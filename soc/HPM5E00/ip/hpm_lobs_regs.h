...
typedef struct {
    ...
    __RW uint32_t IRQ_EN;                      /* 0x4: Interrupt Enable Register */
    __RW uint32_t IRQ_STS;                     /* 0x8: Interrupt Status Register */
    ...
    __RW uint32_t TRIGADDR1;                   /* 0x40: Trigger Address1 */
    __RW uint32_t TRIGADDR2;                   /* 0x44: Trigger Address1 */
    __RW uint32_t TRIGADDR3;                   /* 0x48: Trigger Address1 */
    __RW uint32_t TRIGADDR4;                   /* 0x4C: Trigger Address1 */
    ...
    __R  uint8_t  RESERVED4[52];               /* 0x64 - 0x97: Reserved */
    __RW uint32_t SIGENA;                      /* 0x98: Signal Enable Register */
    __R  uint8_t  RESERVED5[100];              /* 0x9C - 0xFF: Reserved */
    struct {
    ...
    __R  uint8_t  RESERVED6[2480];             /* 0x600 - 0xFAF: Reserved */
 ...
 * FULL_EN (RW)
 *
 * FIFO overflow status interrupt enable
 */
#define LOBS_IRQ_EN_FULL_EN_MASK (0x2U)
#define LOBS_IRQ_EN_FULL_EN_SHIFT (1U)
#define LOBS_IRQ_EN_FULL_EN_SET(x) (((uint32_t)(x) << LOBS_IRQ_EN_FULL_EN_SHIFT) & LOBS_IRQ_EN_FULL_EN_MASK)
#define LOBS_IRQ_EN_FULL_EN_GET(x) (((uint32_t)(x) & LOBS_IRQ_EN_FULL_EN_MASK) >> LOBS_IRQ_EN_FULL_EN_SHIFT)

/*
 * FINAL_EN (RW)
 *
 * final status interrupt enable
 */
#define LOBS_IRQ_EN_FINAL_EN_MASK (0x1U)
#define LOBS_IRQ_EN_FINAL_EN_SHIFT (0U)
#define LOBS_IRQ_EN_FINAL_EN_SET(x) (((uint32_t)(x) << LOBS_IRQ_EN_FINAL_EN_SHIFT) & LOBS_IRQ_EN_FINAL_EN_MASK)
#define LOBS_IRQ_EN_FINAL_EN_GET(x) (((uint32_t)(x) & LOBS_IRQ_EN_FINAL_EN_MASK) >> LOBS_IRQ_EN_FINAL_EN_SHIFT)

/* Bitfield definition for register: IRQ_STS */
/*
 * FULL_STS (W1C)
 *
 * FIFO overflow status interrupt status
 */
#define LOBS_IRQ_STS_FULL_STS_MASK (0x2U)
#define LOBS_IRQ_STS_FULL_STS_SHIFT (1U)
#define LOBS_IRQ_STS_FULL_STS_SET(x) (((uint32_t)(x) << LOBS_IRQ_STS_FULL_STS_SHIFT) & LOBS_IRQ_STS_FULL_STS_MASK)
#define LOBS_IRQ_STS_FULL_STS_GET(x) (((uint32_t)(x) & LOBS_IRQ_STS_FULL_STS_MASK) >> LOBS_IRQ_STS_FULL_STS_SHIFT)
 ...
 */
#define LOBS_IRQ_STS_FINAL_STS_MASK (0x1U)
#define LOBS_IRQ_STS_FINAL_STS_SHIFT (0U)
#define LOBS_IRQ_STS_FINAL_STS_SET(x) (((uint32_t)(x) << LOBS_IRQ_STS_FINAL_STS_SHIFT) & LOBS_IRQ_STS_FINAL_STS_MASK)
#define LOBS_IRQ_STS_FINAL_STS_GET(x) (((uint32_t)(x) & LOBS_IRQ_STS_FINAL_STS_MASK) >> LOBS_IRQ_STS_FINAL_STS_SHIFT)

/* Bitfield definition for register: STREAMCTRL */
/*
 * SAMPLE_INCR (RW)
 *
 * Sample Rate high extension bits, the high 6 bits of the SAMPLE bit field, and the combined value with the SAMPLE bit field are as follows:
 * 4 take one every 5
 * 5 take one every 6
 * 6 take one every 7
 * 9 take one every 10
 * 49 take one every 50
 * 99 take one every 100
 * 499 take one every 500
 * 999 take one every 1000
 * others not supported
 */
#define LOBS_STREAMCTRL_SAMPLE_INCR_MASK (0x7E00U)
#define LOBS_STREAMCTRL_SAMPLE_INCR_SHIFT (9U)
#define LOBS_STREAMCTRL_SAMPLE_INCR_SET(x) (((uint32_t)(x) << LOBS_STREAMCTRL_SAMPLE_INCR_SHIFT) & LOBS_STREAMCTRL_SAMPLE_INCR_MASK)
#define LOBS_STREAMCTRL_SAMPLE_INCR_GET(x) (((uint32_t)(x) & LOBS_STREAMCTRL_SAMPLE_INCR_MASK) >> LOBS_STREAMCTRL_SAMPLE_INCR_SHIFT)
...
/* Bitfield definition for register: TRIGADDR1 */
/*
 * ADDR (RW)
 *
 * Trigger address1
 */
#define LOBS_TRIGADDR1_ADDR_MASK (0xFFFFFFFFUL)
#define LOBS_TRIGADDR1_ADDR_SHIFT (0U)
#define LOBS_TRIGADDR1_ADDR_SET(x) (((uint32_t)(x) << LOBS_TRIGADDR1_ADDR_SHIFT) & LOBS_TRIGADDR1_ADDR_MASK)
#define LOBS_TRIGADDR1_ADDR_GET(x) (((uint32_t)(x) & LOBS_TRIGADDR1_ADDR_MASK) >> LOBS_TRIGADDR1_ADDR_SHIFT)

/* Bitfield definition for register: TRIGADDR2 */
/*
 * ADDR (RW)
 *
 * Trigger address2
 */
#define LOBS_TRIGADDR2_ADDR_MASK (0xFFFFFFFFUL)
#define LOBS_TRIGADDR2_ADDR_SHIFT (0U)
#define LOBS_TRIGADDR2_ADDR_SET(x) (((uint32_t)(x) << LOBS_TRIGADDR2_ADDR_SHIFT) & LOBS_TRIGADDR2_ADDR_MASK)
#define LOBS_TRIGADDR2_ADDR_GET(x) (((uint32_t)(x) & LOBS_TRIGADDR2_ADDR_MASK) >> LOBS_TRIGADDR2_ADDR_SHIFT)

/* Bitfield definition for register: TRIGADDR3 */
/*
 * ADDR (RW)
 *
 * Trigger address3
 */
#define LOBS_TRIGADDR3_ADDR_MASK (0xFFFFFFFFUL)
#define LOBS_TRIGADDR3_ADDR_SHIFT (0U)
#define LOBS_TRIGADDR3_ADDR_SET(x) (((uint32_t)(x) << LOBS_TRIGADDR3_ADDR_SHIFT) & LOBS_TRIGADDR3_ADDR_MASK)
#define LOBS_TRIGADDR3_ADDR_GET(x) (((uint32_t)(x) & LOBS_TRIGADDR3_ADDR_MASK) >> LOBS_TRIGADDR3_ADDR_SHIFT)

/* Bitfield definition for register: TRIGADDR4 */
/*
 * ADDR (RW)
 *
 * Trigger address4
 */
#define LOBS_TRIGADDR4_ADDR_MASK (0xFFFFFFFFUL)
#define LOBS_TRIGADDR4_ADDR_SHIFT (0U)
#define LOBS_TRIGADDR4_ADDR_SET(x) (((uint32_t)(x) << LOBS_TRIGADDR4_ADDR_SHIFT) & LOBS_TRIGADDR4_ADDR_MASK)
#define LOBS_TRIGADDR4_ADDR_GET(x) (((uint32_t)(x) & LOBS_TRIGADDR4_ADDR_MASK) >> LOBS_TRIGADDR4_ADDR_SHIFT)
 ...
 *
 * compare logic
 * 0 and : compare signals must match simultaneously,then trigger
 * 1 or : compare signals only need 1 signal match,then trigger
 */
#define LOBS_STATE_COMPEN_COMPLOGIC_MASK (0x10U)
#define LOBS_STATE_COMPEN_COMPLOGIC_SHIFT (4U)
#define LOBS_STATE_COMPEN_COMPLOGIC_SET(x) (((uint32_t)(x) << LOBS_STATE_COMPEN_COMPLOGIC_SHIFT) & LOBS_STATE_COMPEN_COMPLOGIC_MASK)
#define LOBS_STATE_COMPEN_COMPLOGIC_GET(x) (((uint32_t)(x) & LOBS_STATE_COMPEN_COMPLOGIC_MASK) >> LOBS_STATE_COMPEN_COMPLOGIC_SHIFT)
