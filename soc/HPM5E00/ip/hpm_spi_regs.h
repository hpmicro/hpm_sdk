 ...
 * CMD_OP (RW)
 *
 * Enable DMA tx req and TXFIFOINT work after to write CMD
 * (Master mode only)
 */
#define SPI_CTRL_CMD_OP_MASK (0x10000000UL)
#define SPI_CTRL_CMD_OP_SHIFT (28U)
#define SPI_CTRL_CMD_OP_SET(x) (((uint32_t)(x) << SPI_CTRL_CMD_OP_SHIFT) & SPI_CTRL_CMD_OP_MASK)
#define SPI_CTRL_CMD_OP_GET(x) (((uint32_t)(x) & SPI_CTRL_CMD_OP_MASK) >> SPI_CTRL_CMD_OP_SHIFT)

/*
 * CS_EN (RW)
 *
 * Enable the selection of slave units. Each bit controls a slave selection signal.
 */
 ...
 * CS_NEGEN (RW)
 *
 * Enable  detected cs negedge edge interrupt
 * (Slave mode only)
 */
#define SPI_INTREN_CS_NEGEN_MASK (0x80U)
#define SPI_INTREN_CS_NEGEN_SHIFT (7U)
#define SPI_INTREN_CS_NEGEN_SET(x) (((uint32_t)(x) << SPI_INTREN_CS_NEGEN_SHIFT) & SPI_INTREN_CS_NEGEN_MASK)
#define SPI_INTREN_CS_NEGEN_GET(x) (((uint32_t)(x) & SPI_INTREN_CS_NEGEN_MASK) >> SPI_INTREN_CS_NEGEN_SHIFT)

/*
 * CS_POSEN (RW)
 *
 * Enable  detected cs posedge edge interrupt
 * (Slave mode only)
 */
#define SPI_INTREN_CS_POSEN_MASK (0x40U)
#define SPI_INTREN_CS_POSEN_SHIFT (6U)
#define SPI_INTREN_CS_POSEN_SET(x) (((uint32_t)(x) << SPI_INTREN_CS_POSEN_SHIFT) & SPI_INTREN_CS_POSEN_MASK)
#define SPI_INTREN_CS_POSEN_GET(x) (((uint32_t)(x) & SPI_INTREN_CS_POSEN_MASK) >> SPI_INTREN_CS_POSEN_SHIFT)
 ...
 * CS_NEGINT (W1C)
 *
 * Cs posedge edge interrupt
 * (Slave mode only)
 */
#define SPI_INTRST_CS_NEGINT_MASK (0x80U)
#define SPI_INTRST_CS_NEGINT_SHIFT (7U)
#define SPI_INTRST_CS_NEGINT_SET(x) (((uint32_t)(x) << SPI_INTRST_CS_NEGINT_SHIFT) & SPI_INTRST_CS_NEGINT_MASK)
#define SPI_INTRST_CS_NEGINT_GET(x) (((uint32_t)(x) & SPI_INTRST_CS_NEGINT_MASK) >> SPI_INTRST_CS_NEGINT_SHIFT)
 ...
 * (Slave mode only)
 */
#define SPI_INTRST_CS_POSINT_MASK (0x40U)
#define SPI_INTRST_CS_POSINT_SHIFT (6U)
#define SPI_INTRST_CS_POSINT_SET(x) (((uint32_t)(x) << SPI_INTRST_CS_POSINT_SHIFT) & SPI_INTRST_CS_POSINT_MASK)
#define SPI_INTRST_CS_POSINT_GET(x) (((uint32_t)(x) & SPI_INTRST_CS_POSINT_MASK) >> SPI_INTRST_CS_POSINT_SHIFT)
