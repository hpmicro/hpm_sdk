...
typedef struct {
    ...
    __RW uint32_t GPI_TRIG_CFG;                /* 0x1F024: GPI trigger config */
    __RW uint32_t GPO_TRIG_CFG;                /* 0x1F028: GPO trigger config */
    __R  uint8_t  RESERVED43[4];               /* 0x1F02C - 0x1F02F: Reserved */
 ...
 * PORT2_DIS (RW)
 *
 * set to disable related port(read data 00 in core reigster Port Descriptor (0x0007)
 */
#define ESC_GPR_CFG0_PORT2_DIS_MASK (0x40000UL)
#define ESC_GPR_CFG0_PORT2_DIS_SHIFT (18U)
#define ESC_GPR_CFG0_PORT2_DIS_SET(x) (((uint32_t)(x) << ESC_GPR_CFG0_PORT2_DIS_SHIFT) & ESC_GPR_CFG0_PORT2_DIS_MASK)
#define ESC_GPR_CFG0_PORT2_DIS_GET(x) (((uint32_t)(x) & ESC_GPR_CFG0_PORT2_DIS_MASK) >> ESC_GPR_CFG0_PORT2_DIS_SHIFT)
 ...
 * set to disable related port(read data 00 in core reigster Port Descriptor (0x0007)
 */
#define ESC_GPR_CFG0_PORT1_DIS_MASK (0x20000UL)
#define ESC_GPR_CFG0_PORT1_DIS_SHIFT (17U)
#define ESC_GPR_CFG0_PORT1_DIS_SET(x) (((uint32_t)(x) << ESC_GPR_CFG0_PORT1_DIS_SHIFT) & ESC_GPR_CFG0_PORT1_DIS_MASK)
#define ESC_GPR_CFG0_PORT1_DIS_GET(x) (((uint32_t)(x) & ESC_GPR_CFG0_PORT1_DIS_MASK) >> ESC_GPR_CFG0_PORT1_DIS_SHIFT)
 ...
 * set to disable related port(read data 00 in core reigster Port Descriptor (0x0007)
 */
#define ESC_GPR_CFG0_PORT0_DIS_MASK (0x10000UL)
#define ESC_GPR_CFG0_PORT0_DIS_SHIFT (16U)
#define ESC_GPR_CFG0_PORT0_DIS_SET(x) (((uint32_t)(x) << ESC_GPR_CFG0_PORT0_DIS_SHIFT) & ESC_GPR_CFG0_PORT0_DIS_MASK)
#define ESC_GPR_CFG0_PORT0_DIS_GET(x) (((uint32_t)(x) & ESC_GPR_CFG0_PORT0_DIS_MASK) >> ESC_GPR_CFG0_PORT0_DIS_SHIFT)
 ...
 * SYNC1_PDI_IRQEN (RW)
 *
 * set to enable SYNC1 generate PDI interrupt, also set PDI_SL_CFG.SYNC1_MAER(0x151.bit7)
 */
#define ESC_GPR_CFG0_SYNC1_PDI_IRQEN_MASK (0x20U)
#define ESC_GPR_CFG0_SYNC1_PDI_IRQEN_SHIFT (5U)
#define ESC_GPR_CFG0_SYNC1_PDI_IRQEN_SET(x) (((uint32_t)(x) << ESC_GPR_CFG0_SYNC1_PDI_IRQEN_SHIFT) & ESC_GPR_CFG0_SYNC1_PDI_IRQEN_MASK)
#define ESC_GPR_CFG0_SYNC1_PDI_IRQEN_GET(x) (((uint32_t)(x) & ESC_GPR_CFG0_SYNC1_PDI_IRQEN_MASK) >> ESC_GPR_CFG0_SYNC1_PDI_IRQEN_SHIFT)

/*
 * SYNC0_PDI_IRQEN (RW)
 *
 * set to enable SYNC0 generate PDI interrupt, also set PDI_SL_CFG.SYNC1_MAER(0x151.bit3)
 */
#define ESC_GPR_CFG0_SYNC0_PDI_IRQEN_MASK (0x10U)
#define ESC_GPR_CFG0_SYNC0_PDI_IRQEN_SHIFT (4U)
#define ESC_GPR_CFG0_SYNC0_PDI_IRQEN_SET(x) (((uint32_t)(x) << ESC_GPR_CFG0_SYNC0_PDI_IRQEN_SHIFT) & ESC_GPR_CFG0_SYNC0_PDI_IRQEN_MASK)
#define ESC_GPR_CFG0_SYNC0_PDI_IRQEN_GET(x) (((uint32_t)(x) & ESC_GPR_CFG0_SYNC0_PDI_IRQEN_MASK) >> ESC_GPR_CFG0_SYNC0_PDI_IRQEN_SHIFT)
 ...
 * 1000: wdog trigger;   1001: sw set gpio_ctrl[31];   1110: use gpi_trg_cfg for separate byte control
 * others no trigger
 */
 ...
 * 0000: SOF;  0001: EOF;  0010: pos of  SYNC0;  0011: pos of SYNC1;
 * 0100: pos of LATCH0;   0101: pos of LATCH1;   0110: neg of LATCH0;   0111: neg of LATCH1
 * 1000: wdog trigger;   1001: sw set gpio_ctrl[30];     1110: use gpo_trg_cfg for separate byte control
 * others no trigger
 */
...
/* Bitfield definition for register: GPI_TRIG_CFG */
/*
 * GPI_TRIG_CFG (RW)
 *
 * separage GPI trigger control for latch GPI, 0000~1001 are same as gpi_trig_sel, just 4bit for one byte.
 * Bit3:0 to control GPI[7:0],   bit7:4 to control GPI[15:8]…    bit31:28 to control GPI[63:56]
 */
#define ESC_GPI_TRIG_CFG_GPI_TRIG_CFG_MASK (0xFFFFFFFFUL)
#define ESC_GPI_TRIG_CFG_GPI_TRIG_CFG_SHIFT (0U)
#define ESC_GPI_TRIG_CFG_GPI_TRIG_CFG_SET(x) (((uint32_t)(x) << ESC_GPI_TRIG_CFG_GPI_TRIG_CFG_SHIFT) & ESC_GPI_TRIG_CFG_GPI_TRIG_CFG_MASK)
#define ESC_GPI_TRIG_CFG_GPI_TRIG_CFG_GET(x) (((uint32_t)(x) & ESC_GPI_TRIG_CFG_GPI_TRIG_CFG_MASK) >> ESC_GPI_TRIG_CFG_GPI_TRIG_CFG_SHIFT)

/* Bitfield definition for register: GPO_TRIG_CFG */
/*
 * GPO_TRIG_CFG (RW)
 *
 * separage GPO trigger control for latch GPO, 0000~1001 are same as gpo_trig_sel, just 4bit for one byte.
 * Bit3:0 to control GPO[7:0],   bit7:4 to control GPO[15:8]…    bit31:28 to control GPO[63:56]
 */
#define ESC_GPO_TRIG_CFG_GPO_TRIG_CFG_MASK (0xFFFFFFFFUL)
#define ESC_GPO_TRIG_CFG_GPO_TRIG_CFG_SHIFT (0U)
#define ESC_GPO_TRIG_CFG_GPO_TRIG_CFG_SET(x) (((uint32_t)(x) << ESC_GPO_TRIG_CFG_GPO_TRIG_CFG_SHIFT) & ESC_GPO_TRIG_CFG_GPO_TRIG_CFG_MASK)
#define ESC_GPO_TRIG_CFG_GPO_TRIG_CFG_GET(x) (((uint32_t)(x) & ESC_GPO_TRIG_CFG_GPO_TRIG_CFG_MASK) >> ESC_GPO_TRIG_CFG_GPO_TRIG_CFG_SHIFT)
