...
typedef struct {
    ...
    __RW uint32_t GLB_CTRL3;                   /* 0x1F8:  */
    __R  uint8_t  RESERVED2[4];                /* 0x1FC - 0x1FF: Reserved */
...
/* Bitfield definition for register of struct array PWM: CFG3 */
/*
 * ASYNC_FAULT_SEL (RW)
 *
 * one bit select to enable one async fault from pad, all enabled fault will be OR together with the old async fault logic.
 * (in old version, user can select one async fault by pwm_cfg0.fault_sel_async, and enabled by pwm_cfg0.fault_en_async)
 * each async fault has dedicaate polarity definition in glb_ctrl3.async_fault_pol
 */
#define PWMV2_PWM_CFG3_ASYNC_FAULT_SEL_MASK (0xFFFFU)
#define PWMV2_PWM_CFG3_ASYNC_FAULT_SEL_SHIFT (0U)
#define PWMV2_PWM_CFG3_ASYNC_FAULT_SEL_SET(x) (((uint32_t)(x) << PWMV2_PWM_CFG3_ASYNC_FAULT_SEL_SHIFT) & PWMV2_PWM_CFG3_ASYNC_FAULT_SEL_MASK)
#define PWMV2_PWM_CFG3_ASYNC_FAULT_SEL_GET(x) (((uint32_t)(x) & PWMV2_PWM_CFG3_ASYNC_FAULT_SEL_MASK) >> PWMV2_PWM_CFG3_ASYNC_FAULT_SEL_SHIFT)
 ...
 * DEBUG_OPT (RW)
 *
 * set to disable debug fault immediately when exit debug mode
 */
#define PWMV2_GLB_CTRL2_DEBUG_OPT_MASK (0x400000UL)
#define PWMV2_GLB_CTRL2_DEBUG_OPT_SHIFT (22U)
#define PWMV2_GLB_CTRL2_DEBUG_OPT_SET(x) (((uint32_t)(x) << PWMV2_GLB_CTRL2_DEBUG_OPT_SHIFT) & PWMV2_GLB_CTRL2_DEBUG_OPT_MASK)
#define PWMV2_GLB_CTRL2_DEBUG_OPT_GET(x) (((uint32_t)(x) & PWMV2_GLB_CTRL2_DEBUG_OPT_MASK) >> PWMV2_GLB_CTRL2_DEBUG_OPT_SHIFT)
...
/* Bitfield definition for register: GLB_CTRL3 */
/*
 * ASYNC_FAULT_POL (RW)
 *
 * async fault polarity, default 0 for active high; set to 1 for active low
 */
#define PWMV2_GLB_CTRL3_ASYNC_FAULT_POL_MASK (0xFFFFU)
#define PWMV2_GLB_CTRL3_ASYNC_FAULT_POL_SHIFT (0U)
#define PWMV2_GLB_CTRL3_ASYNC_FAULT_POL_SET(x) (((uint32_t)(x) << PWMV2_GLB_CTRL3_ASYNC_FAULT_POL_SHIFT) & PWMV2_GLB_CTRL3_ASYNC_FAULT_POL_MASK)
#define PWMV2_GLB_CTRL3_ASYNC_FAULT_POL_GET(x) (((uint32_t)(x) & PWMV2_GLB_CTRL3_ASYNC_FAULT_POL_MASK) >> PWMV2_GLB_CTRL3_ASYNC_FAULT_POL_SHIFT)
