...
typedef struct {
    ...
    __R  uint8_t  RESERVED4[104];              /* 0x178 - 0x1DF: Reserved */
    __R  uint32_t TIMESTAMP;                   /* 0x1E0: timestamp */
    __R  uint8_t  RESERVED5[12];               /* 0x1E4 - 0x1EF: Reserved */
    __RW uint32_t ADC_THRESHOLD;               /* 0x1F0: adc_threshold */
    ...
    __RW uint32_t ADCX_VAL_SW;                 /* 0x20C: adcx_val_sw */
    __RW uint32_t ADCY_CFG0;                   /* 0x210: adcy_cfg0 */
    __RW uint32_t ADCY_CFG1;                   /* 0x214: adcy_cfg1 */
    __RW uint32_t ADCY_CFG2;                   /* 0x218: adcy_cfg2 */
    __RW uint32_t ADCY_VAL_SW;                 /* 0x21C: adcy_val_sw */
    __RW uint32_t CAL_CFG;                     /* 0x220: cal_cfg */
    __RW uint32_t ADC_INJECT_CTRL;             /* 0x224: adc_inject_ctrl */
    __R  uint8_t  RESERVED7[8];                /* 0x228 - 0x22F: Reserved */
    __RW uint32_t PHASE_PARAM;                 /* 0x230: phase_param */
    __RW uint32_t POS_ADJ;                     /* 0x234: pos_adj */
    ...
    __R  uint8_t  RESERVED10[8];               /* 0x298 - 0x29F: Reserved */
    __R  uint32_t CALC_STATE;                  /* 0x2A0: calc_state */
    __R  uint8_t  RESERVED11[28];              /* 0x2A4 - 0x2BF: Reserved */
    __RW uint32_t TOGI_CFG0;                   /* 0x2C0: togi_cfg0 */
    __RW uint32_t TOGI_CFG1;                   /* 0x2C4: togi_cfg1 */
    __R  uint8_t  RESERVED12[8];               /* 0x2C8 - 0x2CF: Reserved */
    __R  uint32_t SINP_ACC;                    /* 0x2D0: sinp_acc */
    __R  uint32_t SINN_ACC;                    /* 0x2D4: sinn_acc */
    __R  uint32_t COSP_ACC;                    /* 0x2D8: cosp_acc */
    __R  uint32_t COSN_ACC;                    /* 0x2DC: cosn_acc */
} QEIV2_Type;
...
/*
 * SW_PULSE0_RESTART (RW)
 *
 * set to restart cycle counter for configed pulse_num. HW auto clear
 */
...
/*
 * SW_CYCLE0_RESTART (RW)
 *
 * set to restart pulse counter for configed cycle_num. HW auto clear
 */
 ...
 * PULSE0_ONESHOT (RW)
 *
 * set to use oneshot mode for configed pulse_num
 */
 ...
 * CYCLE0_ONESHOT (RW)
 *
 * set to use oneshot mode for configed cycle_num
 */
 ...
 * TRIG_PULSE0_EN (RW)
 *
 * set to enable trigger start cycle counter for configed pulse_num(from the selected edge)
 */
 ...
 * TRIG_CYCLE0_EN (RW)
 *
 * set to enable trigger start pulse counter for configed cycle_num
 */
...
/* Bitfield definition for register: TIMESTAMP */
/*
 * TIMESTAMP (RO)
 *
 * for SIN/COS mode, it saves the timestampe of the begining of first ADC sample time;
 * for ABZ mode, it saves the timestampe of edge of input signals
 */
...
/* Bitfield definition for register: ADC_THRESHOLD */
/*
 * LOW_LIMIT (RW)
 *
 * for SINCOS mode, if (max+min/2) of the two adc result, is small than limit,
 * then this value is treated as unvalid, no position output.
 * this is uesd to avoid wrong adc resule(such as 0 or same sin cos value)
 */
 ...
 * HIGH_LIMIT (RW)
 *
 * high limit for SINCOS mode adc result
 */
...
/* Bitfield definition for register: ADCX_VAL_SW */
/*
 * ADCX_VAL_SW (RW)
 *
 * adc X channel value when using adc inject feature.
 *  32bit signed value
 * NOTE: x_offset is not used when adc_inject_en is set, x_param0 and x_param1 are still used,
 * user can leave them as default if do not want to use them
 */
#define QEIV2_ADCX_VAL_SW_ADCX_VAL_SW_MASK (0xFFFFFFFFUL)
#define QEIV2_ADCX_VAL_SW_ADCX_VAL_SW_SHIFT (0U)
#define QEIV2_ADCX_VAL_SW_ADCX_VAL_SW_SET(x) (((uint32_t)(x) << QEIV2_ADCX_VAL_SW_ADCX_VAL_SW_SHIFT) & QEIV2_ADCX_VAL_SW_ADCX_VAL_SW_MASK)
#define QEIV2_ADCX_VAL_SW_ADCX_VAL_SW_GET(x) (((uint32_t)(x) & QEIV2_ADCX_VAL_SW_ADCX_VAL_SW_MASK) >> QEIV2_ADCX_VAL_SW_ADCX_VAL_SW_SHIFT)
...
/* Bitfield definition for register: ADCY_VAL_SW */
/*
 * ADCY_VAL_SW (RW)
 *
 */
#define QEIV2_ADCY_VAL_SW_ADCY_VAL_SW_MASK (0xFFFFFFFFUL)
#define QEIV2_ADCY_VAL_SW_ADCY_VAL_SW_SHIFT (0U)
#define QEIV2_ADCY_VAL_SW_ADCY_VAL_SW_SET(x) (((uint32_t)(x) << QEIV2_ADCY_VAL_SW_ADCY_VAL_SW_SHIFT) & QEIV2_ADCY_VAL_SW_ADCY_VAL_SW_MASK)
#define QEIV2_ADCY_VAL_SW_ADCY_VAL_SW_GET(x) (((uint32_t)(x) & QEIV2_ADCY_VAL_SW_ADCY_VAL_SW_MASK) >> QEIV2_ADCY_VAL_SW_ADCY_VAL_SW_SHIFT)
...
/* Bitfield definition for register: ADC_INJECT_CTRL */
/*
 * ADC_INJECT_EN (RW)
 *
 * set to use adcx_val and adcy_val from software
 */
#define QEIV2_ADC_INJECT_CTRL_ADC_INJECT_EN_MASK (0x80000000UL)
#define QEIV2_ADC_INJECT_CTRL_ADC_INJECT_EN_SHIFT (31U)
#define QEIV2_ADC_INJECT_CTRL_ADC_INJECT_EN_SET(x) (((uint32_t)(x) << QEIV2_ADC_INJECT_CTRL_ADC_INJECT_EN_SHIFT) & QEIV2_ADC_INJECT_CTRL_ADC_INJECT_EN_MASK)
#define QEIV2_ADC_INJECT_CTRL_ADC_INJECT_EN_GET(x) (((uint32_t)(x) & QEIV2_ADC_INJECT_CTRL_ADC_INJECT_EN_MASK) >> QEIV2_ADC_INJECT_CTRL_ADC_INJECT_EN_SHIFT)

/*
 * ADCY_INJ_VALID (WO)
 *
 * set for adc X channel valid
 */
#define QEIV2_ADC_INJECT_CTRL_ADCY_INJ_VALID_MASK (0x2U)
#define QEIV2_ADC_INJECT_CTRL_ADCY_INJ_VALID_SHIFT (1U)
#define QEIV2_ADC_INJECT_CTRL_ADCY_INJ_VALID_SET(x) (((uint32_t)(x) << QEIV2_ADC_INJECT_CTRL_ADCY_INJ_VALID_SHIFT) & QEIV2_ADC_INJECT_CTRL_ADCY_INJ_VALID_MASK)
#define QEIV2_ADC_INJECT_CTRL_ADCY_INJ_VALID_GET(x) (((uint32_t)(x) & QEIV2_ADC_INJECT_CTRL_ADCY_INJ_VALID_MASK) >> QEIV2_ADC_INJECT_CTRL_ADCY_INJ_VALID_SHIFT)

/*
 * ADCX_INJ_VALID (WO)
 *
 * set for adc Y channel valid
 */
#define QEIV2_ADC_INJECT_CTRL_ADCX_INJ_VALID_MASK (0x1U)
#define QEIV2_ADC_INJECT_CTRL_ADCX_INJ_VALID_SHIFT (0U)
#define QEIV2_ADC_INJECT_CTRL_ADCX_INJ_VALID_SET(x) (((uint32_t)(x) << QEIV2_ADC_INJECT_CTRL_ADCX_INJ_VALID_SHIFT) & QEIV2_ADC_INJECT_CTRL_ADCX_INJ_VALID_MASK)
#define QEIV2_ADC_INJECT_CTRL_ADCX_INJ_VALID_GET(x) (((uint32_t)(x) & QEIV2_ADC_INJECT_CTRL_ADCX_INJ_VALID_MASK) >> QEIV2_ADC_INJECT_CTRL_ADCX_INJ_VALID_SHIFT)
...
/* Bitfield definition for register: POS_ADJ */
/*
 * POS_ADJ (RW)
 *
 */
#define QEIV2_POS_ADJ_POS_ADJ_MASK (0xFFFFFFFFUL)
#define QEIV2_POS_ADJ_POS_ADJ_SHIFT (0U)
#define QEIV2_POS_ADJ_POS_ADJ_SET(x) (((uint32_t)(x) << QEIV2_POS_ADJ_POS_ADJ_SHIFT) & QEIV2_POS_ADJ_POS_ADJ_MASK)
#define QEIV2_POS_ADJ_POS_ADJ_GET(x) (((uint32_t)(x) & QEIV2_POS_ADJ_POS_ADJ_MASK) >> QEIV2_POS_ADJ_POS_ADJ_SHIFT)
...
/* Bitfield definition for register: CALC_STATE */
/*
 * STATE (RO)
 *
 * 0：calculate finish
 * other: in calculating
 */
#define QEIV2_CALC_STATE_STATE_MASK (0xF000000UL)
#define QEIV2_CALC_STATE_STATE_SHIFT (24U)
#define QEIV2_CALC_STATE_STATE_GET(x) (((uint32_t)(x) & QEIV2_CALC_STATE_STATE_MASK) >> QEIV2_CALC_STATE_STATE_SHIFT)

/* Bitfield definition for register: TOGI_CFG0 */
/*
 * SIN_TOGI (RW)
 *
 * set to use TOGI architecture for single SIN input
 */
...
/* Bitfield definition for register: TOGI_CFG1 */
/*
 * W_PARAM (RW)
 *
 * w_param is angle speed, which is  2*PI*signal_hz/adc_sample_rate*2^28.
 * for example, 50Hz signal with 1MHz ADC sample rate, angle speed is 2*3.14159*50/1000000*0x10000000,
 * which is 84331(0x1496B, default value)
 * if 50Hz with 2MHz sample rate, should config to 0xA4B6
 */
...
/* Bitfield definition for register: SINP_ACC */
/*
 * SINP_ACC (RO)
 *
 * positive SIN value acc in one period, updated when calculated SIN from pos to neg.
 * each SIN value is 16bit unsinged value(0x8000 for SIN30(0.5) )
 */
...
/* Bitfield definition for register: SINN_ACC */
/*
 * SINN_ACC (RO)
 *
 * negative SIN value acc in one period, updated when calculated SIN from neg to pos
 * each SIN value is 16bit unsinged value(0x8000 for SIN330(-0.5) )
 */
...
/* Bitfield definition for register: COSP_ACC */
/*
 * COSP_ACC (RO)
 *
 * positive COS value acc in one period, updated when calculated COS from pos to neg
 */
...
/* Bitfield definition for register: COSN_ACC */
/*
 * COSN_ACC (RO)
 *
 * negative COS value acc in one period, updated when calculated COS from neg to pos
 */
