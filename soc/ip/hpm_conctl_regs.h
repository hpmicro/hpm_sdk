 ...
 *
 * ENET0 LPI Interrupt Enable
 */
#define CONCTL_CTRL2_ENET0_LPI_INTR_EN_MASK (0x20000000UL)
#define CONCTL_CTRL2_ENET0_LPI_INTR_EN_SHIFT (29U)
#define CONCTL_CTRL2_ENET0_LPI_INTR_EN_SET(x) (((uint32_t)(x) << CONCTL_CTRL2_ENET0_LPI_INTR_EN_SHIFT) & CONCTL_CTRL2_ENET0_LPI_INTR_EN_MASK)
#define CONCTL_CTRL2_ENET0_LPI_INTR_EN_GET(x) (((uint32_t)(x) & CONCTL_CTRL2_ENET0_LPI_INTR_EN_MASK) >> CONCTL_CTRL2_ENET0_LPI_INTR_EN_SHIFT)
...
/*
 * ENET1_LPI_INTR_EN (RW)
 *
 * ENET1 LPI Interrupt Enable
 */
#define CONCTL_CTRL3_ENET1_LPI_INTR_EN_MASK (0x20000000UL)
#define CONCTL_CTRL3_ENET1_LPI_INTR_EN_SHIFT (29U)
#define CONCTL_CTRL3_ENET1_LPI_INTR_EN_SET(x) (((uint32_t)(x) << CONCTL_CTRL3_ENET1_LPI_INTR_EN_SHIFT) & CONCTL_CTRL3_ENET1_LPI_INTR_EN_MASK)
#define CONCTL_CTRL3_ENET1_LPI_INTR_EN_GET(x) (((uint32_t)(x) & CONCTL_CTRL3_ENET1_LPI_INTR_EN_MASK) >> CONCTL_CTRL3_ENET1_LPI_INTR_EN_SHIFT)
