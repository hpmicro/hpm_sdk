...
/**
 * @brief Enable wakeup pin or software wakeup
 * @param [in] ptr DGO base address
 */
static inline void pdgo_enable_wkup_software_wakeup(PDGO_Type *ptr)
{
    ptr->DGO_CTR1 |= PDGO_DGO_CTR1_WAKEUP_EN_MASK;
}

/**
 * @brief Disable wakeup pin or software wakeup
 * @param [in] ptr DGO base address
 */
static inline void pdgo_disable_wkup_software_wakeup(PDGO_Type *ptr)
{
    ptr->DGO_CTR1 &= ~PDGO_DGO_CTR1_WAKEUP_EN_MASK;
}
