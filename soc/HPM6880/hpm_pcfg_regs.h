...
typedef struct {
    ...
    __RW uint32_t POWER_TRAP;                  /* 0x40: power trap */
    ...
    __R  uint8_t  RESERVED3[16];               /* 0x70 - 0x7F: Reserved */
    __RW uint32_t DCDCM_MODE;                  /* 0x80: DCDCM mode select */
    __RW uint32_t DCDCM_LPMODE;                /* 0x84: DCDCM low power mode */
    __RW uint32_t DCDCM_PROT;                  /* 0x88: DCDCM protection */
    __RW uint32_t DCDCM_CURRENT;               /* 0x8C: DCDCM current estimation */
    __RW uint32_t DCDCM_ADVMODE;               /* 0x90: DCDCM advance setting */
    __RW uint32_t DCDCM_ADVPARAM;              /* 0x94: DCDCM advance parameter */
    __RW uint32_t DCDCM_MISC;                  /* 0x98: DCDCM misc parameter */
    __RW uint32_t DCDCM_DEBUG;                 /* 0x9C: DCDCM Debug */
    __RW uint32_t DCDCM_START_TIME;            /* 0xA0: DCDCM ramp time */
    __RW uint32_t DCDCM_RESUME_TIME;           /* 0xA4: DCDCM resume time */
    __RW uint32_t DCDCM_POWER_CONFIG;          /* 0xA8: DCDCM power config */
} PCFG_Type;
...
/* Bitfield definition for register: DCDCM_MODE */
/*
 * READY (RO)
 *
 * Ready flag
 ...
 * 1: DCDCM is ready
 */
#define PCFG_DCDCM_MODE_READY_MASK (0x10000000UL)
#define PCFG_DCDCM_MODE_READY_SHIFT (28U)
#define PCFG_DCDCM_MODE_READY_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MODE_READY_MASK) >> PCFG_DCDCM_MODE_READY_SHIFT)
 ...
 * 111: expert mode
 */
#define PCFG_DCDCM_MODE_MODE_MASK (0x70000UL)
#define PCFG_DCDCM_MODE_MODE_SHIFT (16U)
#define PCFG_DCDCM_MODE_MODE_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MODE_MODE_SHIFT) & PCFG_DCDCM_MODE_MODE_MASK)
#define PCFG_DCDCM_MODE_MODE_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MODE_MODE_MASK) >> PCFG_DCDCM_MODE_MODE_SHIFT)

/*
 * VOLT (RW)
 *
 * DCDCM voltage in mV in normal mode,  value valid through 600-1375, , step 25mV.  Hardware select voltage no less than target if not on valid steps, with maximum 1375mV.
 * 600: 600mV
 * 625: 625mV
 * . . .
 * 1375:1375mV
 */
#define PCFG_DCDCM_MODE_VOLT_MASK (0xFFFU)
#define PCFG_DCDCM_MODE_VOLT_SHIFT (0U)
#define PCFG_DCDCM_MODE_VOLT_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MODE_VOLT_SHIFT) & PCFG_DCDCM_MODE_VOLT_MASK)
#define PCFG_DCDCM_MODE_VOLT_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MODE_VOLT_MASK) >> PCFG_DCDCM_MODE_VOLT_SHIFT)

/* Bitfield definition for register: DCDCM_LPMODE */
/*
 * STBY_VOLT (RW)
 *
 * DCDCM voltage in mV in standby mode,  ,  value valid through 600-1375, , step 25mV.  Hardware select voltage no less than target if not on valid steps, with maximum 1375mV.
 * 600: 600mV
 * 625: 625mV
 * . . .
 * 1375:1375mV
 */
#define PCFG_DCDCM_LPMODE_STBY_VOLT_MASK (0xFFFU)
#define PCFG_DCDCM_LPMODE_STBY_VOLT_SHIFT (0U)
#define PCFG_DCDCM_LPMODE_STBY_VOLT_SET(x) (((uint32_t)(x) << PCFG_DCDCM_LPMODE_STBY_VOLT_SHIFT) & PCFG_DCDCM_LPMODE_STBY_VOLT_MASK)
#define PCFG_DCDCM_LPMODE_STBY_VOLT_GET(x) (((uint32_t)(x) & PCFG_DCDCM_LPMODE_STBY_VOLT_MASK) >> PCFG_DCDCM_LPMODE_STBY_VOLT_SHIFT)

/* Bitfield definition for register: DCDCM_PROT */
/*
 * ILIMIT_LP (RW)
 *
 * over current setting for low power mode
 ...
 * 1:200mA
 */
#define PCFG_DCDCM_PROT_ILIMIT_LP_MASK (0x10000000UL)
#define PCFG_DCDCM_PROT_ILIMIT_LP_SHIFT (28U)
#define PCFG_DCDCM_PROT_ILIMIT_LP_SET(x) (((uint32_t)(x) << PCFG_DCDCM_PROT_ILIMIT_LP_SHIFT) & PCFG_DCDCM_PROT_ILIMIT_LP_MASK)
#define PCFG_DCDCM_PROT_ILIMIT_LP_GET(x) (((uint32_t)(x) & PCFG_DCDCM_PROT_ILIMIT_LP_MASK) >> PCFG_DCDCM_PROT_ILIMIT_LP_SHIFT)
 ...
 * 1: overcurrent happened in low power mode
 */
#define PCFG_DCDCM_PROT_OVERLOAD_LP_MASK (0x1000000UL)
#define PCFG_DCDCM_PROT_OVERLOAD_LP_SHIFT (24U)
#define PCFG_DCDCM_PROT_OVERLOAD_LP_GET(x) (((uint32_t)(x) & PCFG_DCDCM_PROT_OVERLOAD_LP_MASK) >> PCFG_DCDCM_PROT_OVERLOAD_LP_SHIFT)
 ...
 * 1: power loss protection disabled, DCDCM try working after power voltage drop
 */
#define PCFG_DCDCM_PROT_DISABLE_POWER_LOSS_MASK (0x800000UL)
#define PCFG_DCDCM_PROT_DISABLE_POWER_LOSS_SHIFT (23U)
#define PCFG_DCDCM_PROT_DISABLE_POWER_LOSS_SET(x) (((uint32_t)(x) << PCFG_DCDCM_PROT_DISABLE_POWER_LOSS_SHIFT) & PCFG_DCDCM_PROT_DISABLE_POWER_LOSS_MASK)
#define PCFG_DCDCM_PROT_DISABLE_POWER_LOSS_GET(x) (((uint32_t)(x) & PCFG_DCDCM_PROT_DISABLE_POWER_LOSS_MASK) >> PCFG_DCDCM_PROT_DISABLE_POWER_LOSS_SHIFT)
 ...
 * 1: input power is too low
 */
#define PCFG_DCDCM_PROT_POWER_LOSS_FLAG_MASK (0x10000UL)
#define PCFG_DCDCM_PROT_POWER_LOSS_FLAG_SHIFT (16U)
#define PCFG_DCDCM_PROT_POWER_LOSS_FLAG_GET(x) (((uint32_t)(x) & PCFG_DCDCM_PROT_POWER_LOSS_FLAG_MASK) >> PCFG_DCDCM_PROT_POWER_LOSS_FLAG_SHIFT)
 ...
 * 1: protection disabled, DCDCM continue to adjust output voltage
 */
#define PCFG_DCDCM_PROT_DISABLE_OVERVOLTAGE_MASK (0x8000U)
#define PCFG_DCDCM_PROT_DISABLE_OVERVOLTAGE_SHIFT (15U)
#define PCFG_DCDCM_PROT_DISABLE_OVERVOLTAGE_SET(x) (((uint32_t)(x) << PCFG_DCDCM_PROT_DISABLE_OVERVOLTAGE_SHIFT) & PCFG_DCDCM_PROT_DISABLE_OVERVOLTAGE_MASK)
#define PCFG_DCDCM_PROT_DISABLE_OVERVOLTAGE_GET(x) (((uint32_t)(x) & PCFG_DCDCM_PROT_DISABLE_OVERVOLTAGE_MASK) >> PCFG_DCDCM_PROT_DISABLE_OVERVOLTAGE_SHIFT)
 ...
 * 1: output is unexpected high
 */
#define PCFG_DCDCM_PROT_OVERVOLT_FLAG_MASK (0x100U)
#define PCFG_DCDCM_PROT_OVERVOLT_FLAG_SHIFT (8U)
#define PCFG_DCDCM_PROT_OVERVOLT_FLAG_GET(x) (((uint32_t)(x) & PCFG_DCDCM_PROT_OVERVOLT_FLAG_MASK) >> PCFG_DCDCM_PROT_OVERVOLT_FLAG_SHIFT)

/*
 * DISABLE_SHORT (RW)
 *
 * disable output short circuit protection
 * 0: short circuits protection enabled, DCDCM shut down if short circuit on ouput detected
 * 1: short circuit protection disabled
 */
#define PCFG_DCDCM_PROT_DISABLE_SHORT_MASK (0x80U)
#define PCFG_DCDCM_PROT_DISABLE_SHORT_SHIFT (7U)
#define PCFG_DCDCM_PROT_DISABLE_SHORT_SET(x) (((uint32_t)(x) << PCFG_DCDCM_PROT_DISABLE_SHORT_SHIFT) & PCFG_DCDCM_PROT_DISABLE_SHORT_MASK)
 ...
 * 1: 1.3A
 */
#define PCFG_DCDCM_PROT_SHORT_CURRENT_MASK (0x10U)
#define PCFG_DCDCM_PROT_SHORT_CURRENT_SHIFT (4U)
#define PCFG_DCDCM_PROT_SHORT_CURRENT_SET(x) (((uint32_t)(x) << PCFG_DCDCM_PROT_SHORT_CURRENT_SHIFT) & PCFG_DCDCM_PROT_SHORT_CURRENT_MASK)
#define PCFG_DCDCM_PROT_SHORT_CURRENT_GET(x) (((uint32_t)(x) & PCFG_DCDCM_PROT_SHORT_CURRENT_MASK) >> PCFG_DCDCM_PROT_SHORT_CURRENT_SHIFT)
 ...
 * 1: short circuits detected
 */
#define PCFG_DCDCM_PROT_SHORT_FLAG_MASK (0x1U)
#define PCFG_DCDCM_PROT_SHORT_FLAG_SHIFT (0U)
#define PCFG_DCDCM_PROT_SHORT_FLAG_GET(x) (((uint32_t)(x) & PCFG_DCDCM_PROT_SHORT_FLAG_MASK) >> PCFG_DCDCM_PROT_SHORT_FLAG_SHIFT)

/* Bitfield definition for register: DCDCM_CURRENT */
/*
 * ESTI_EN (RW)
 *
 * enable current measure
 */
#define PCFG_DCDCM_CURRENT_ESTI_EN_MASK (0x8000U)
#define PCFG_DCDCM_CURRENT_ESTI_EN_SHIFT (15U)
#define PCFG_DCDCM_CURRENT_ESTI_EN_SET(x) (((uint32_t)(x) << PCFG_DCDCM_CURRENT_ESTI_EN_SHIFT) & PCFG_DCDCM_CURRENT_ESTI_EN_MASK)
#define PCFG_DCDCM_CURRENT_ESTI_EN_GET(x) (((uint32_t)(x) & PCFG_DCDCM_CURRENT_ESTI_EN_MASK) >> PCFG_DCDCM_CURRENT_ESTI_EN_SHIFT)
 ...
 * 1: data is valid
 */
#define PCFG_DCDCM_CURRENT_VALID_MASK (0x100U)
#define PCFG_DCDCM_CURRENT_VALID_SHIFT (8U)
#define PCFG_DCDCM_CURRENT_VALID_GET(x) (((uint32_t)(x) & PCFG_DCDCM_CURRENT_VALID_MASK) >> PCFG_DCDCM_CURRENT_VALID_SHIFT)

/*
 * LEVEL (RO)
 *
 * DCDCM current level, current level is num * 50mA
 */
#define PCFG_DCDCM_CURRENT_LEVEL_MASK (0x1FU)
#define PCFG_DCDCM_CURRENT_LEVEL_SHIFT (0U)
#define PCFG_DCDCM_CURRENT_LEVEL_GET(x) (((uint32_t)(x) & PCFG_DCDCM_CURRENT_LEVEL_MASK) >> PCFG_DCDCM_CURRENT_LEVEL_SHIFT)

/* Bitfield definition for register: DCDCM_ADVMODE */
/*
 * EN_RCSCALE (RW)
 *
 * Enable RC scale
 */
#define PCFG_DCDCM_ADVMODE_EN_RCSCALE_MASK (0x7000000UL)
#define PCFG_DCDCM_ADVMODE_EN_RCSCALE_SHIFT (24U)
#define PCFG_DCDCM_ADVMODE_EN_RCSCALE_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_EN_RCSCALE_SHIFT) & PCFG_DCDCM_ADVMODE_EN_RCSCALE_MASK)
#define PCFG_DCDCM_ADVMODE_EN_RCSCALE_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVMODE_EN_RCSCALE_MASK) >> PCFG_DCDCM_ADVMODE_EN_RCSCALE_SHIFT)
 ...
 * Loop C number
 */
#define PCFG_DCDCM_ADVMODE_DC_C_MASK (0x300000UL)
#define PCFG_DCDCM_ADVMODE_DC_C_SHIFT (20U)
#define PCFG_DCDCM_ADVMODE_DC_C_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_DC_C_SHIFT) & PCFG_DCDCM_ADVMODE_DC_C_MASK)
#define PCFG_DCDCM_ADVMODE_DC_C_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVMODE_DC_C_MASK) >> PCFG_DCDCM_ADVMODE_DC_C_SHIFT)
 ...
 * Loop R number
 */
#define PCFG_DCDCM_ADVMODE_DC_R_MASK (0xF0000UL)
#define PCFG_DCDCM_ADVMODE_DC_R_SHIFT (16U)
#define PCFG_DCDCM_ADVMODE_DC_R_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_DC_R_SHIFT) & PCFG_DCDCM_ADVMODE_DC_R_MASK)
#define PCFG_DCDCM_ADVMODE_DC_R_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVMODE_DC_R_MASK) >> PCFG_DCDCM_ADVMODE_DC_R_SHIFT)
 ...
 * 1: feed forward detect is enabled
 */
#define PCFG_DCDCM_ADVMODE_EN_FF_DET_MASK (0x40U)
#define PCFG_DCDCM_ADVMODE_EN_FF_DET_SHIFT (6U)
#define PCFG_DCDCM_ADVMODE_EN_FF_DET_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_EN_FF_DET_SHIFT) & PCFG_DCDCM_ADVMODE_EN_FF_DET_MASK)
 ...
 * 1: feed forward loop is enabled
 */
#define PCFG_DCDCM_ADVMODE_EN_FF_LOOP_MASK (0x20U)
#define PCFG_DCDCM_ADVMODE_EN_FF_LOOP_SHIFT (5U)
#define PCFG_DCDCM_ADVMODE_EN_FF_LOOP_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_EN_FF_LOOP_SHIFT) & PCFG_DCDCM_ADVMODE_EN_FF_LOOP_MASK)
#define PCFG_DCDCM_ADVMODE_EN_FF_LOOP_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVMODE_EN_FF_LOOP_MASK) >> PCFG_DCDCM_ADVMODE_EN_FF_LOOP_SHIFT)
 ...
 * 1: enter low power mode if current is detected low
 */
#define PCFG_DCDCM_ADVMODE_EN_AUTOLP_MASK (0x10U)
#define PCFG_DCDCM_ADVMODE_EN_AUTOLP_SHIFT (4U)
#define PCFG_DCDCM_ADVMODE_EN_AUTOLP_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_EN_AUTOLP_SHIFT) & PCFG_DCDCM_ADVMODE_EN_AUTOLP_MASK)
#define PCFG_DCDCM_ADVMODE_EN_AUTOLP_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVMODE_EN_AUTOLP_MASK) >> PCFG_DCDCM_ADVMODE_EN_AUTOLP_SHIFT)
 ...
 * 1: change to CCM mode when voltage excess
 */
#define PCFG_DCDCM_ADVMODE_EN_DCM_EXIT_MASK (0x8U)
#define PCFG_DCDCM_ADVMODE_EN_DCM_EXIT_SHIFT (3U)
#define PCFG_DCDCM_ADVMODE_EN_DCM_EXIT_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_EN_DCM_EXIT_SHIFT) & PCFG_DCDCM_ADVMODE_EN_DCM_EXIT_MASK)
#define PCFG_DCDCM_ADVMODE_EN_DCM_EXIT_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVMODE_EN_DCM_EXIT_MASK) >> PCFG_DCDCM_ADVMODE_EN_DCM_EXIT_SHIFT)
 ...
 * 1: skip narrow pulse
 */
#define PCFG_DCDCM_ADVMODE_EN_SKIP_MASK (0x4U)
#define PCFG_DCDCM_ADVMODE_EN_SKIP_SHIFT (2U)
#define PCFG_DCDCM_ADVMODE_EN_SKIP_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_EN_SKIP_SHIFT) & PCFG_DCDCM_ADVMODE_EN_SKIP_MASK)
#define PCFG_DCDCM_ADVMODE_EN_SKIP_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVMODE_EN_SKIP_MASK) >> PCFG_DCDCM_ADVMODE_EN_SKIP_SHIFT)
 ...
 * 1: skip if voltage is excess
 */
#define PCFG_DCDCM_ADVMODE_EN_IDLE_MASK (0x2U)
#define PCFG_DCDCM_ADVMODE_EN_IDLE_SHIFT (1U)
#define PCFG_DCDCM_ADVMODE_EN_IDLE_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_EN_IDLE_SHIFT) & PCFG_DCDCM_ADVMODE_EN_IDLE_MASK)
#define PCFG_DCDCM_ADVMODE_EN_IDLE_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVMODE_EN_IDLE_MASK) >> PCFG_DCDCM_ADVMODE_EN_IDLE_SHIFT)
 ...
 * 1: DCM mode
 */
#define PCFG_DCDCM_ADVMODE_EN_DCM_MASK (0x1U)
#define PCFG_DCDCM_ADVMODE_EN_DCM_SHIFT (0U)
#define PCFG_DCDCM_ADVMODE_EN_DCM_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVMODE_EN_DCM_SHIFT) & PCFG_DCDCM_ADVMODE_EN_DCM_MASK)
#define PCFG_DCDCM_ADVMODE_EN_DCM_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVMODE_EN_DCM_MASK) >> PCFG_DCDCM_ADVMODE_EN_DCM_SHIFT)

/* Bitfield definition for register: DCDCM_ADVPARAM */
/*
 * MIN_DUT (RW)
 *
 * minimum duty cycle
 */
#define PCFG_DCDCM_ADVPARAM_MIN_DUT_MASK (0x7F00U)
#define PCFG_DCDCM_ADVPARAM_MIN_DUT_SHIFT (8U)
#define PCFG_DCDCM_ADVPARAM_MIN_DUT_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVPARAM_MIN_DUT_SHIFT) & PCFG_DCDCM_ADVPARAM_MIN_DUT_MASK)
#define PCFG_DCDCM_ADVPARAM_MIN_DUT_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVPARAM_MIN_DUT_MASK) >> PCFG_DCDCM_ADVPARAM_MIN_DUT_SHIFT)
 ...
 * maximum duty cycle
 */
#define PCFG_DCDCM_ADVPARAM_MAX_DUT_MASK (0x7FU)
#define PCFG_DCDCM_ADVPARAM_MAX_DUT_SHIFT (0U)
#define PCFG_DCDCM_ADVPARAM_MAX_DUT_SET(x) (((uint32_t)(x) << PCFG_DCDCM_ADVPARAM_MAX_DUT_SHIFT) & PCFG_DCDCM_ADVPARAM_MAX_DUT_MASK)
#define PCFG_DCDCM_ADVPARAM_MAX_DUT_GET(x) (((uint32_t)(x) & PCFG_DCDCM_ADVPARAM_MAX_DUT_MASK) >> PCFG_DCDCM_ADVPARAM_MAX_DUT_SHIFT)

/* Bitfield definition for register: DCDCM_MISC */
/*
 * EN_HYST (RW)
 *
 * hysteres enable
 */
#define PCFG_DCDCM_MISC_EN_HYST_MASK (0x10000000UL)
#define PCFG_DCDCM_MISC_EN_HYST_SHIFT (28U)
#define PCFG_DCDCM_MISC_EN_HYST_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_EN_HYST_SHIFT) & PCFG_DCDCM_MISC_EN_HYST_MASK)
#define PCFG_DCDCM_MISC_EN_HYST_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_EN_HYST_MASK) >> PCFG_DCDCM_MISC_EN_HYST_SHIFT)
 ...
 * hysteres sign
 */
#define PCFG_DCDCM_MISC_HYST_SIGN_MASK (0x2000000UL)
#define PCFG_DCDCM_MISC_HYST_SIGN_SHIFT (25U)
#define PCFG_DCDCM_MISC_HYST_SIGN_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_HYST_SIGN_SHIFT) & PCFG_DCDCM_MISC_HYST_SIGN_MASK)
#define PCFG_DCDCM_MISC_HYST_SIGN_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_HYST_SIGN_MASK) >> PCFG_DCDCM_MISC_HYST_SIGN_SHIFT)
 ...
 * hysteres threshold
 */
#define PCFG_DCDCM_MISC_HYST_THRS_MASK (0x1000000UL)
#define PCFG_DCDCM_MISC_HYST_THRS_SHIFT (24U)
#define PCFG_DCDCM_MISC_HYST_THRS_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_HYST_THRS_SHIFT) & PCFG_DCDCM_MISC_HYST_THRS_MASK)
#define PCFG_DCDCM_MISC_HYST_THRS_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_HYST_THRS_MASK) >> PCFG_DCDCM_MISC_HYST_THRS_SHIFT)
 ...
 * Loop RC scale threshold
 */
#define PCFG_DCDCM_MISC_RC_SCALE_MASK (0x100000UL)
#define PCFG_DCDCM_MISC_RC_SCALE_SHIFT (20U)
#define PCFG_DCDCM_MISC_RC_SCALE_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_RC_SCALE_SHIFT) & PCFG_DCDCM_MISC_RC_SCALE_MASK)
#define PCFG_DCDCM_MISC_RC_SCALE_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_RC_SCALE_MASK) >> PCFG_DCDCM_MISC_RC_SCALE_SHIFT)
 ...
 * Loop feed forward number
 */
#define PCFG_DCDCM_MISC_DC_FF_MASK (0x70000UL)
#define PCFG_DCDCM_MISC_DC_FF_SHIFT (16U)
#define PCFG_DCDCM_MISC_DC_FF_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_DC_FF_SHIFT) & PCFG_DCDCM_MISC_DC_FF_MASK)
#define PCFG_DCDCM_MISC_DC_FF_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_DC_FF_MASK) >> PCFG_DCDCM_MISC_DC_FF_SHIFT)
 ...
 * overload for threshold for lod power mode
 */
#define PCFG_DCDCM_MISC_OL_THRE_MASK (0x300U)
#define PCFG_DCDCM_MISC_OL_THRE_SHIFT (8U)
#define PCFG_DCDCM_MISC_OL_THRE_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_OL_THRE_SHIFT) & PCFG_DCDCM_MISC_OL_THRE_MASK)
#define PCFG_DCDCM_MISC_OL_THRE_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_OL_THRE_MASK) >> PCFG_DCDCM_MISC_OL_THRE_SHIFT)
 ...
 * 1: 25mV
 */
#define PCFG_DCDCM_MISC_OL_HYST_MASK (0x10U)
#define PCFG_DCDCM_MISC_OL_HYST_SHIFT (4U)
#define PCFG_DCDCM_MISC_OL_HYST_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_OL_HYST_SHIFT) & PCFG_DCDCM_MISC_OL_HYST_MASK)
#define PCFG_DCDCM_MISC_OL_HYST_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_OL_HYST_MASK) >> PCFG_DCDCM_MISC_OL_HYST_SHIFT)
 ...
 * 1: delay enabled
 */
#define PCFG_DCDCM_MISC_DELAY_MASK (0x4U)
#define PCFG_DCDCM_MISC_DELAY_SHIFT (2U)
#define PCFG_DCDCM_MISC_DELAY_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_DELAY_SHIFT) & PCFG_DCDCM_MISC_DELAY_MASK)
#define PCFG_DCDCM_MISC_DELAY_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_DELAY_MASK) >> PCFG_DCDCM_MISC_DELAY_SHIFT)
 ...
 * 1: select RC24M oscillator
 */
#define PCFG_DCDCM_MISC_CLK_SEL_MASK (0x2U)
#define PCFG_DCDCM_MISC_CLK_SEL_SHIFT (1U)
#define PCFG_DCDCM_MISC_CLK_SEL_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_CLK_SEL_SHIFT) & PCFG_DCDCM_MISC_CLK_SEL_MASK)
#define PCFG_DCDCM_MISC_CLK_SEL_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_CLK_SEL_MASK) >> PCFG_DCDCM_MISC_CLK_SEL_SHIFT)
 ...
 * 1: steping enabled
 */
#define PCFG_DCDCM_MISC_EN_STEP_MASK (0x1U)
#define PCFG_DCDCM_MISC_EN_STEP_SHIFT (0U)
#define PCFG_DCDCM_MISC_EN_STEP_SET(x) (((uint32_t)(x) << PCFG_DCDCM_MISC_EN_STEP_SHIFT) & PCFG_DCDCM_MISC_EN_STEP_MASK)
#define PCFG_DCDCM_MISC_EN_STEP_GET(x) (((uint32_t)(x) & PCFG_DCDCM_MISC_EN_STEP_MASK) >> PCFG_DCDCM_MISC_EN_STEP_SHIFT)

/* Bitfield definition for register: DCDCM_DEBUG */
/*
 * UPDATE_TIME (RW)
 *
 * DCDCM voltage change time in 24M clock cycles, default value is 1mS
 */
#define PCFG_DCDCM_DEBUG_UPDATE_TIME_MASK (0xFFFFFUL)
#define PCFG_DCDCM_DEBUG_UPDATE_TIME_SHIFT (0U)
#define PCFG_DCDCM_DEBUG_UPDATE_TIME_SET(x) (((uint32_t)(x) << PCFG_DCDCM_DEBUG_UPDATE_TIME_SHIFT) & PCFG_DCDCM_DEBUG_UPDATE_TIME_MASK)
#define PCFG_DCDCM_DEBUG_UPDATE_TIME_GET(x) (((uint32_t)(x) & PCFG_DCDCM_DEBUG_UPDATE_TIME_MASK) >> PCFG_DCDCM_DEBUG_UPDATE_TIME_SHIFT)

/* Bitfield definition for register: DCDCM_START_TIME */
/*
 * START_TIME (RW)
 *
 * Start delay for DCDCM to turn on, in 24M clock cycles, default value is 3mS
 */
#define PCFG_DCDCM_START_TIME_START_TIME_MASK (0xFFFFFUL)
#define PCFG_DCDCM_START_TIME_START_TIME_SHIFT (0U)
#define PCFG_DCDCM_START_TIME_START_TIME_SET(x) (((uint32_t)(x) << PCFG_DCDCM_START_TIME_START_TIME_SHIFT) & PCFG_DCDCM_START_TIME_START_TIME_MASK)
#define PCFG_DCDCM_START_TIME_START_TIME_GET(x) (((uint32_t)(x) & PCFG_DCDCM_START_TIME_START_TIME_MASK) >> PCFG_DCDCM_START_TIME_START_TIME_SHIFT)

/* Bitfield definition for register: DCDCM_RESUME_TIME */
/*
 * RESUME_TIME (RW)
 *
 * Resume delay for DCDCM to recover from low power mode, in 24M clock cycles, default value is 10uS
 */
#define PCFG_DCDCM_RESUME_TIME_RESUME_TIME_MASK (0xFFFFFUL)
#define PCFG_DCDCM_RESUME_TIME_RESUME_TIME_SHIFT (0U)
#define PCFG_DCDCM_RESUME_TIME_RESUME_TIME_SET(x) (((uint32_t)(x) << PCFG_DCDCM_RESUME_TIME_RESUME_TIME_SHIFT) & PCFG_DCDCM_RESUME_TIME_RESUME_TIME_MASK)
#define PCFG_DCDCM_RESUME_TIME_RESUME_TIME_GET(x) (((uint32_t)(x) & PCFG_DCDCM_RESUME_TIME_RESUME_TIME_MASK) >> PCFG_DCDCM_RESUME_TIME_RESUME_TIME_SHIFT)

/* Bitfield definition for register: DCDCM_POWER_CONFIG */
/*
 * RETENTION (RW)
 *
 * DCDCM enter standby mode, which will reduce voltage for memory content retention
 * 0: Shutdown DCDCM
 * 1: reduce DCDC voltage
 */
#define PCFG_DCDCM_POWER_CONFIG_RETENTION_MASK (0x10000UL)
#define PCFG_DCDCM_POWER_CONFIG_RETENTION_SHIFT (16U)
#define PCFG_DCDCM_POWER_CONFIG_RETENTION_SET(x) (((uint32_t)(x) << PCFG_DCDCM_POWER_CONFIG_RETENTION_SHIFT) & PCFG_DCDCM_POWER_CONFIG_RETENTION_MASK)
#define PCFG_DCDCM_POWER_CONFIG_RETENTION_GET(x) (((uint32_t)(x) & PCFG_DCDCM_POWER_CONFIG_RETENTION_MASK) >> PCFG_DCDCM_POWER_CONFIG_RETENTION_SHIFT)
