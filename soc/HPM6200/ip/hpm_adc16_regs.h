...
typedef struct {
    ...
    __R  uint8_t  RESERVED3[4];                /* 0x808 - 0x80B: Reserved */
    __RW uint32_t SEQ_DMA_CFG;                 /* 0x80C:  */
    __RW uint32_t SEQ_QUE[16];                 /* 0x810 - 0x84C:  */
    __R  uint8_t  RESERVED4[944];              /* 0x850 - 0xBFF: Reserved */
    struct {
    ...
    __R  uint8_t  RESERVED5[768];              /* 0xD00 - 0xFFF: Reserved */
    __RW uint32_t SAMPLE_CFG[16];              /* 0x1000 - 0x103C:  */
    __R  uint8_t  RESERVED6[196];              /* 0x1040 - 0x1103: Reserved */
    __RW uint32_t CONV_CFG1;                   /* 0x1104:  */
    __RW uint32_t ADC_CFG0;                    /* 0x1108:  */
    __R  uint8_t  RESERVED7[4];                /* 0x110C - 0x110F: Reserved */
    __RW uint32_t INT_STS;                     /* 0x1110:  */
    __RW uint32_t INT_EN;                      /* 0x1114:  */
    __R  uint8_t  RESERVED8[232];              /* 0x1118 - 0x11FF: Reserved */
    __RW uint32_t ANA_CTRL0;                   /* 0x1200:  */
    __R  uint8_t  RESERVED9[12];               /* 0x1204 - 0x120F: Reserved */
    __RW uint32_t ANA_STATUS;                  /* 0x1210:  */
    __R  uint8_t  RESERVED10[492];             /* 0x1214 - 0x13FF: Reserved */
    __RW uint16_t ADC16_PARAMS[34];            /* 0x1400 - 0x1442:  */
    __RW uint32_t ADC16_CONFIG0;               /* 0x1444:  */
    __R  uint8_t  RESERVED11[24];              /* 0x1448 - 0x145F: Reserved */
