...
typedef struct {
    ...
    __RW uint32_t TRGOCFG[68];                 /* 0x100 - 0x20C: Trigger manager output configure register */
    __R  uint8_t  RESERVED1[240];              /* 0x210 - 0x2FF: Reserved */
    __RW uint32_t DMACFG[4];                   /* 0x300 - 0x30C: DMA request configure register */
    __R  uint8_t  RESERVED2[240];              /* 0x310 - 0x3FF: Reserved */
 ...
 * 1- Invert the output
 */
#define TRGM_TRGOCFG_OUTINV_MASK (0x200U)
#define TRGM_TRGOCFG_OUTINV_SHIFT (9U)
...
#define TRGM_TRGOCFG_PLA_IN0 (30UL)
#define TRGM_TRGOCFG_PLA_IN1 (31UL)
#define TRGM_TRGOCFG_PLA_IN2 (32UL)
#define TRGM_TRGOCFG_PLA_IN3 (33UL)
#define TRGM_TRGOCFG_PLA_IN4 (34UL)
#define TRGM_TRGOCFG_PLA_IN5 (35UL)
#define TRGM_TRGOCFG_PLA_IN6 (36UL)
#define TRGM_TRGOCFG_PLA_IN7 (37UL)
...
#define TRGM_TRGOCFG_DAC_BUF_TRIG (58UL)
#define TRGM_TRGOCFG_DAC0_STEP_TRIG (59UL)
#define TRGM_TRGOCFG_DAC1_STEP_TRIG (60UL)
#define TRGM_TRGOCFG_CMPX_WIN (61UL)
#define TRGM_TRGOCFG_CAN_PTPC0_CAP (62UL)
#define TRGM_TRGOCFG_CAN_PTPC1_CAP (63UL)
#define TRGM_TRGOCFG_SDFM_EVT0 (64UL)
#define TRGM_TRGOCFG_SDFM_EVT1 (65UL)
#define TRGM_TRGOCFG_SDFM_EVT2 (66UL)
#define TRGM_TRGOCFG_SDFM_EVT3 (67UL)
