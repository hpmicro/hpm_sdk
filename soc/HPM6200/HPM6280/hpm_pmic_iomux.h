...
#define IOC_PY05_FUNC_CTL_WDOG_RST             IOC_PAD_FUNC_CTL_ALT_SELECT_SET(1) /* dropped macro, please use macro with prefix PIOC_ */
#define PIOC_PY05_FUNC_CTL_WDOG_RST            IOC_PAD_FUNC_CTL_ALT_SELECT_SET(1)
...
#define IOC_PY06_FUNC_CTL_UART_TXD             IOC_PAD_FUNC_CTL_ALT_SELECT_SET(1) /* dropped macro, please use macro with prefix PIOC_ */
#define PIOC_PY06_FUNC_CTL_UART_TXD            IOC_PAD_FUNC_CTL_ALT_SELECT_SET(1)
...
#define IOC_PY07_FUNC_CTL_UART_RXD             IOC_PAD_FUNC_CTL_ALT_SELECT_SET(1) /* dropped macro, please use macro with prefix PIOC_ */
#define PIOC_PY07_FUNC_CTL_UART_RXD            IOC_PAD_FUNC_CTL_ALT_SELECT_SET(1)
