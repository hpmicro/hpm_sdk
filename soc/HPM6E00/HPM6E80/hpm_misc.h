...
#define CORE0_ILM_SYSTEM_BASE  (0x01180000U)
#define CORE0_DLM_SYSTEM_BASE  (0x011C0000U)
#define CORE1_ILM_SYSTEM_BASE  (0x01300000U)
#define CORE1_DLM_SYSTEM_BASE  (0x01340000U)
