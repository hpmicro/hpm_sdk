...
typedef struct {
    ...
    __RW uint32_t APB2AXIS_CAM_REQDATA_0;      /* 0x120: data0 */
    __RW uint32_t APB2AXIS_CAM_REQDATA_1;      /* 0x124: data1 */
    __RW uint32_t APB2AXIS_CAM_REQDATA_2;      /* 0x128: data2 */
    ...
    __RW uint32_t CPU_PORT_EGRESS_STMID_ESELECT; /* 0x12800: Stream Identification */
    ...
    __RW uint32_t CPU_PORT_EGRESS_STMID_AMACLO;/* 0x12858:  */
    __RW uint32_t CPU_PORT_EGRESS_STMID_AMACHI;/* 0x1285C:  */
    __R  uint8_t  RESERVED45[160];             /* 0x12860 - 0x128FF: Reserved */
    __RW uint32_t CPU_PORT_EGRESS_FRER_CONTROL;/* 0x12900: Frame Replication and Elimination */
    __RW uint32_t CPU_PORT_EGRESS_FRER_SIDSEL; /* 0x12904:  */
    __RW uint32_t CPU_PORT_EGRESS_FRER_IRFUNC; /* 0x12908:  */
    __RW uint32_t CPU_PORT_EGRESS_FRER_SRFUNC; /* 0x1290C:  */
    __RW uint32_t CPU_PORT_EGRESS_FRER_FSELECT;/* 0x12910:  */
    __R  uint8_t  RESERVED46[44];              /* 0x12914 - 0x1293F: Reserved */
    __RW uint32_t CPU_PORT_EGRESS_FRER_FCTRL;  /* 0x12940:  */
    __RW uint32_t CPU_PORT_EGRESS_FRER_RESETMSEC; /* 0x12944:  */
    __RW uint32_t CPU_PORT_EGRESS_FRER_LATRSPERIOD; /* 0x12948:  */
    __RW uint32_t CPU_PORT_EGRESS_FRER_LATTESTPERIOD; /* 0x1294C:  */
    __RW uint32_t CPU_PORT_EGRESS_FRER_LATERRDIFFALW; /* 0x12950:  */
    __RW uint32_t CPU_PORT_EGRESS_FRER_LATERRCNT; /* 0x12954:  */
    __R  uint8_t  RESERVED47[8];               /* 0x12958 - 0x1295F: Reserved */
    __R  uint32_t EGFRCNT[8];                  /* 0x12960 - 0x1297C:  */
    __R  uint8_t  RESERVED48[5760];            /* 0x12980 - 0x13FFF: Reserved */
    ...
    __R  uint8_t  RESERVED49[2000];            /* 0x14030 - 0x147FF: Reserved */
    __RW uint32_t CPU_PORT_IGRESS_STMID_ESELECT; /* 0x14800: Stream Identification */
    __R  uint8_t  RESERVED50[60];              /* 0x14804 - 0x1483F: Reserved */
    ...
    __R  uint8_t  RESERVED51[4];               /* 0x1484C - 0x1484F: Reserved */
    __RW uint32_t CPU_PORT_IGRESS_STMID_MACLO; /* 0x14850:  */
    __RW uint32_t CPU_PORT_IGRESS_STMID_MACHI; /* 0x14854:  */
    __RW uint32_t CPU_PORT_IGRESS_STMID_AMACLO;/* 0x14858:  */
    __RW uint32_t CPU_PORT_IGRESS_STMID_AMACHI;/* 0x1485C:  */
    __R  uint8_t  RESERVED52[160];             /* 0x14860 - 0x148FF: Reserved */
    __RW uint32_t CPU_PORT_IGRESS_FRER_CONTROL;/* 0x14900: Frame Replication and Elimination */
    __RW uint32_t CPU_PORT_IGRESS_FRER_SIDSEL; /* 0x14904:  */
    __RW uint32_t CPU_PORT_IGRESS_FRER_IRFUNC; /* 0x14908:  */
    __RW uint32_t CPU_PORT_IGRESS_FRER_SRFUNC; /* 0x1490C:  */
    __RW uint32_t CPU_PORT_IGRESS_FRER_FSELECT;/* 0x14910:  */
    __R  uint8_t  RESERVED53[44];              /* 0x14914 - 0x1493F: Reserved */
    __RW uint32_t CPU_PORT_IGRESS_FRER_FCTRL;  /* 0x14940:  */
    __RW uint32_t CPU_PORT_IGRESS_FRER_RESETMSEC; /* 0x14944:  */
    __RW uint32_t CPU_PORT_IGRESS_FRER_LATRSPERIOD; /* 0x14948:  */
    __RW uint32_t CPU_PORT_IGRESS_FRER_LATTESTPERIOD; /* 0x1494C:  */
    __RW uint32_t CPU_PORT_IGRESS_FRER_LATERRDIFFALW; /* 0x14950:  */
    __RW uint32_t CPU_PORT_IGRESS_FRER_LATERRCNT; /* 0x14954:  */
    __R  uint8_t  RESERVED54[8];               /* 0x14958 - 0x1495F: Reserved */
    __R  uint32_t IGFRCNT[8];                  /* 0x14960 - 0x1497C:  */
    __R  uint8_t  RESERVED55[13956];           /* 0x14980 - 0x18003: Reserved */
    ...
    struct {
        ...
        struct {
            __W  uint32_t TXDATA[60];          /* 0x21800 - 0x218EC:  */
            __W  uint32_t TSYN_TXBUF_TQUE_AND_TX_LEN; /* 0x218F0:  */
            __R  uint8_t  RESERVED0[4];        /* 0x218F4 - 0x218F7: Reserved */
            __R  uint32_t TSYN_TXBUF_TX_TIMESTAMP_L; /* 0x218F8:  */
            __R  uint32_t TSYN_TXBUF_TX_TIMESTAMP_H; /* 0x218FC:  */
        } BIN[8];
        ...
        struct {
            __RW uint32_t TSN_SHAPER_ACLIST_ENTRY_L; /* 0x23800:  */
            __RW uint32_t TSN_SHAPER_ACLIST_ENTRY_H; /* 0x23804:  */
        } SHACL[256];
...
/* Bitfield definition for register: APB2AXIS_CAM_REQDATA_0 */
/*
 * ENTRY_NUM (R/W)
 *
 * entry number
 */
#define TSW_APB2AXIS_CAM_REQDATA_0_ENTRY_NUM_MASK (0xFFFF0000UL)
#define TSW_APB2AXIS_CAM_REQDATA_0_ENTRY_NUM_SHIFT (16U)
#define TSW_APB2AXIS_CAM_REQDATA_0_ENTRY_NUM_SET(x) (((uint32_t)(x) << TSW_APB2AXIS_CAM_REQDATA_0_ENTRY_NUM_SHIFT) & TSW_APB2AXIS_CAM_REQDATA_0_ENTRY_NUM_MASK)
#define TSW_APB2AXIS_CAM_REQDATA_0_ENTRY_NUM_GET(x) (((uint32_t)(x) & TSW_APB2AXIS_CAM_REQDATA_0_ENTRY_NUM_MASK) >> TSW_APB2AXIS_CAM_REQDATA_0_ENTRY_NUM_SHIFT)
 ...
 */
#define TSW_APB2AXIS_CAM_REQDATA_0_TYPE_MASK (0x300U)
#define TSW_APB2AXIS_CAM_REQDATA_0_TYPE_SHIFT (8U)
#define TSW_APB2AXIS_CAM_REQDATA_0_TYPE_SET(x) (((uint32_t)(x) << TSW_APB2AXIS_CAM_REQDATA_0_TYPE_SHIFT) & TSW_APB2AXIS_CAM_REQDATA_0_TYPE_MASK)
#define TSW_APB2AXIS_CAM_REQDATA_0_TYPE_GET(x) (((uint32_t)(x) & TSW_APB2AXIS_CAM_REQDATA_0_TYPE_MASK) >> TSW_APB2AXIS_CAM_REQDATA_0_TYPE_SHIFT)
 ...
 */
#define TSW_APB2AXIS_CAM_REQDATA_0_CH_MASK (0x1U)
#define TSW_APB2AXIS_CAM_REQDATA_0_CH_SHIFT (0U)
#define TSW_APB2AXIS_CAM_REQDATA_0_CH_SET(x) (((uint32_t)(x) << TSW_APB2AXIS_CAM_REQDATA_0_CH_SHIFT) & TSW_APB2AXIS_CAM_REQDATA_0_CH_MASK)
#define TSW_APB2AXIS_CAM_REQDATA_0_CH_GET(x) (((uint32_t)(x) & TSW_APB2AXIS_CAM_REQDATA_0_CH_MASK) >> TSW_APB2AXIS_CAM_REQDATA_0_CH_SHIFT)

/* Bitfield definition for register: APB2AXIS_CAM_REQDATA_1 */
/*
 * DESTMAC_LO_PORT_VEC (R/W)
 *
 * dest-mac[31:0] when CH=0；PORT_VEC when CH=1
 */
#define TSW_APB2AXIS_CAM_REQDATA_1_DESTMAC_LO_PORT_VEC_MASK (0xFFFFFFFFUL)
#define TSW_APB2AXIS_CAM_REQDATA_1_DESTMAC_LO_PORT_VEC_SHIFT (0U)
#define TSW_APB2AXIS_CAM_REQDATA_1_DESTMAC_LO_PORT_VEC_SET(x) (((uint32_t)(x) << TSW_APB2AXIS_CAM_REQDATA_1_DESTMAC_LO_PORT_VEC_SHIFT) & TSW_APB2AXIS_CAM_REQDATA_1_DESTMAC_LO_PORT_VEC_MASK)
#define TSW_APB2AXIS_CAM_REQDATA_1_DESTMAC_LO_PORT_VEC_GET(x) (((uint32_t)(x) & TSW_APB2AXIS_CAM_REQDATA_1_DESTMAC_LO_PORT_VEC_MASK) >> TSW_APB2AXIS_CAM_REQDATA_1_DESTMAC_LO_PORT_VEC_SHIFT)

/* Bitfield definition for register: APB2AXIS_CAM_REQDATA_2 */
/*
 * VID (R/W)
 *
 * VLAN-ID value (12 bit) for the VLAN_ID table. Use the fefault VLAN-ID(VID=1), if setup an entry for non-VLAN traffic.
 */
#define TSW_APB2AXIS_CAM_REQDATA_2_VID_MASK (0xFFF0000UL)
#define TSW_APB2AXIS_CAM_REQDATA_2_VID_SHIFT (16U)
#define TSW_APB2AXIS_CAM_REQDATA_2_VID_SET(x) (((uint32_t)(x) << TSW_APB2AXIS_CAM_REQDATA_2_VID_SHIFT) & TSW_APB2AXIS_CAM_REQDATA_2_VID_MASK)
#define TSW_APB2AXIS_CAM_REQDATA_2_VID_GET(x) (((uint32_t)(x) & TSW_APB2AXIS_CAM_REQDATA_2_VID_MASK) >> TSW_APB2AXIS_CAM_REQDATA_2_VID_SHIFT)
 ...
 */
#define TSW_APB2AXIS_CAM_REQDATA_2_DESTMAC_HI_MASK (0xFFFFU)
#define TSW_APB2AXIS_CAM_REQDATA_2_DESTMAC_HI_SHIFT (0U)
#define TSW_APB2AXIS_CAM_REQDATA_2_DESTMAC_HI_SET(x) (((uint32_t)(x) << TSW_APB2AXIS_CAM_REQDATA_2_DESTMAC_HI_SHIFT) & TSW_APB2AXIS_CAM_REQDATA_2_DESTMAC_HI_MASK)
#define TSW_APB2AXIS_CAM_REQDATA_2_DESTMAC_HI_GET(x) (((uint32_t)(x) & TSW_APB2AXIS_CAM_REQDATA_2_DESTMAC_HI_MASK) >> TSW_APB2AXIS_CAM_REQDATA_2_DESTMAC_HI_SHIFT)
...
/* Bitfield definition for register: CPU_PORT_EGRESS_STMID_AMACLO */
/*
 * AMACL (R/W)
 *
 * Active Destination MAC, MAC-Address [31:0]
 */
...
/* Bitfield definition for register: CPU_PORT_IGRESS_STMID_AMACLO */
/*
 * AMACL (RW)
 *
 * Active Destination MAC, MAC-Address [31:0]
...
/* Bitfield definition for register of struct array TSNPORT: TSYN_TXBUF_TQUE_AND_TX_LEN */
/*
 * TXBUF_TQUE (WO)
 *
 * TXBUF_TQUE
...
/* Bitfield definition for register of struct array TSNPORT: TSYN_TXBUF_TX_TIMESTAMP_L */
/*
 * TXBUF_TX_TIMESTAMP_L (RO)
 *
 * TXBUF_TX_TIMESTAMP_L
 */
...
/* Bitfield definition for register of struct array TSNPORT: TSYN_TXBUF_TX_TIMESTAMP_H */
/*
 * TXBUF_TX_TIMESTAMP_H (RO)
 *
 * TXBUF_TX_TIMESTAMP_H
 */
...
/* Bitfield definition for register of struct array TSNPORT: TSN_SHAPER_ACLIST_ENTRY_L */
/*
 * TAS_GPIO (R/W)
 *
...
/* Bitfield definition for register of struct array TSNPORT: TSN_SHAPER_ACLIST_ENTRY_H */
/*
 * TIME (R/W)
 *
 ...
 *
 * RMII REFCLK output enable
 * 0: Disable REFCLK output
 * 1: Enable EFCLK output
 */
