 ...
 * @defgroup sysctl_hpm6880_interface SYSCTL driver APIs for HPM6880
...
typedef enum {
    ...
    sysctl_resource_pow_vis = SYSCTL_RESOURCE_POW_VIS,
    sysctl_resource_pow_cpu0 = SYSCTL_RESOURCE_POW_CPU0,
    sysctl_resource_pow_gpu = SYSCTL_RESOURCE_POW_GPU,
    sysctl_resource_rst_soc = SYSCTL_RESOURCE_RST_SOC,
    sysctl_resource_rst_con = SYSCTL_RESOURCE_RST_CON,
    sysctl_resource_rst_vis = SYSCTL_RESOURCE_RST_VIS,
    sysctl_resource_rst_cpu0 = SYSCTL_RESOURCE_RST_CPU0,
    sysctl_resource_rst_gpu = SYSCTL_RESOURCE_RST_GPU,
...
typedef enum {
    ...
    monitor_target_clk1_pll1 = 23,
    monitor_target_clk0_pll2 = 24,
    monitor_target_clk1_pll2 = 25,
    monitor_target_clk0_pll3 = 26,
    monitor_target_clk0_pll4 = 27,
    monitor_target_clk_top_cpu0 = 128,
    monitor_target_clk_top_mchtmr0 = 129,
    monitor_target_clk_top_gpu0 = 130,
    monitor_target_clk_top_axif = 131,
    monitor_target_clk_top_axis = 132,
    monitor_target_clk_top_axic = 133,
    monitor_target_clk_top_axiv = 134,
    monitor_target_clk_top_axid = 135,
    monitor_target_clk_top_can0 = 136,
    monitor_target_clk_top_can1 = 137,
    monitor_target_clk_top_can2 = 138,
    monitor_target_clk_top_can3 = 139,
    monitor_target_clk_top_can4 = 140,
    monitor_target_clk_top_can5 = 141,
    monitor_target_clk_top_can6 = 142,
    monitor_target_clk_top_can7 = 143,
    monitor_target_clk_top_lin0 = 144,
    monitor_target_clk_top_lin1 = 145,
    monitor_target_clk_top_lin2 = 146,
    monitor_target_clk_top_lin3 = 147,
    monitor_target_clk_top_lin4 = 148,
    monitor_target_clk_top_lin5 = 149,
    monitor_target_clk_top_lin6 = 150,
    monitor_target_clk_top_lin7 = 151,
    monitor_target_clk_top_i2c0 = 152,
    monitor_target_clk_top_i2c1 = 153,
    monitor_target_clk_top_i2c2 = 154,
    monitor_target_clk_top_i2c3 = 155,
    monitor_target_clk_top_spi0 = 156,
    monitor_target_clk_top_spi1 = 157,
    monitor_target_clk_top_spi2 = 158,
    monitor_target_clk_top_spi3 = 159,
    monitor_target_clk_top_uart0 = 160,
    monitor_target_clk_top_uart1 = 161,
    monitor_target_clk_top_uart2 = 162,
    monitor_target_clk_top_uart3 = 163,
    monitor_target_clk_top_uart4 = 164,
    monitor_target_clk_top_uart5 = 165,
    monitor_target_clk_top_uart6 = 166,
    monitor_target_clk_top_uart7 = 167,
    monitor_target_clk_top_gptmr0 = 168,
    monitor_target_clk_top_gptmr1 = 169,
    monitor_target_clk_top_gptmr2 = 170,
    monitor_target_clk_top_gptmr3 = 171,
    monitor_target_clk_top_gptmr4 = 172,
    monitor_target_clk_top_gptmr5 = 173,
    monitor_target_clk_top_gptmr6 = 174,
    monitor_target_clk_top_gptmr7 = 175,
    monitor_target_clk_top_xpi0 = 176,
    monitor_target_clk_top_xram = 177,
    monitor_target_clk_top_ana0 = 178,
    monitor_target_clk_top_ana1 = 179,
    monitor_target_clk_top_aud0 = 180,
    monitor_target_clk_top_aud1 = 181,
    monitor_target_clk_top_aud2 = 182,
    monitor_target_clk_top_aud3 = 183,
    monitor_target_clk_top_eth0 = 184,
    monitor_target_clk_top_ptp0 = 185,
    monitor_target_clk_top_sdxc0 = 186,
    monitor_target_clk_top_sdxc1 = 187,
    monitor_target_clk_top_ntmr0 = 188,
    monitor_target_clk_top_ref0 = 189,
    monitor_target_clk_top_ref1 = 190,
    monitor_target_clk_top_cam0 = 191,
    monitor_target_clk_top_cam1 = 192,
    monitor_target_clk_top_lcd0 = 193,
    monitor_target_clk_top_lcd1 = 194,
    monitor_target_clk_top_csi0 = 195,
    monitor_target_clk_top_csi1 = 196,
} monitor_target_t;
