...
.. tabs::
   ...
   .. tab:: gnu-gcc
      ...
      1. **下载并解压工具链**
         ...
         - 从 `RISC-V GNU 工具链发布页面 <https://github.com/hpmicro/riscv-gnu-toolchain/releases>`_ 下载 RISC-V GNU 工具链。
...
如果您需要快速创建自己的工程，请参考 :ref:`cmake_quick_start`，其中提供了 CMakeLists.txt 的最小模板和典型场景示例。
