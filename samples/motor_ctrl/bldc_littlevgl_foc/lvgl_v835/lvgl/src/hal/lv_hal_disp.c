...
#elif LV_USE_GPU_HPMICRO_PDMA
    driver->draw_ctx_init = lv_draw_hpmicro_pdma_ctx_init;
    driver->draw_ctx_deinit = lv_draw_hpmicro_pdma_ctx_init;
    driver->draw_ctx_size = sizeof(lv_draw_hpmicro_pdma_ctx_t);
#else
