.. _ecat_eoe_http_server_freertos:

ECAT_EOE_HTTP_SERVER_FREERTOS
==============================

1. 概述
---------

ECAT_EOE_HTTP_SERVER_FREERTOS示例演示基于EtherCAT EoE功能实现的HTTP Server功能。
...
6.4 使用浏览器客户端输入设置的从设备IP地址，例如输入http://192.168.100.10，回车后会显示如下的页面：
    **注意：** 此示例可以成功运行，通过使用360或IE内核的浏览器

    .. image:: doc/eoe_http_server.png
          :alt:
...
.. code-block:: console
   ...
   EtherCAT EOE HTTP Server sample with LwIP stack and Freertos.
   Init EEPROM content.
