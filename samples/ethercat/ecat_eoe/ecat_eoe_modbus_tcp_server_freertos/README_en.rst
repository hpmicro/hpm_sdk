...
The ECAT_EOE_ModBus_TCP_Server_Freertos example demonstrates ModBus TCP Server functionality implemented based on EtherCAT EoE features.

This example uses FreeRTOS as the real-time operating system and employs LWIP Socket interface to handle network communication.
...
6.4 Test functionality using Modbus Poll software
    1. Open Modbus Poll software and create a new connection

    .. image:: doc/eoe_modbus_poll_connect.png
       :alt:

    2. After connection, you can read Modbus register values
    ...
    4. Read values after modification
