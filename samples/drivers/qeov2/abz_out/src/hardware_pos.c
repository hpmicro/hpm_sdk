...
void hardware_gen_postion_to_qeo(void)
{
    ...
    trgm_pos_matrix_config(HPM_TRGM0, BOARD_QEO_TRGM_POS, trgm_pos_matrix_in_from_mtg0_pos0, false);
    ...
    trgm_pos_matrix_config(HPM_TRGM0, BOARD_QEO_TRGM_POS, BOARD_QEO_TRGM_POS_IN, false);
