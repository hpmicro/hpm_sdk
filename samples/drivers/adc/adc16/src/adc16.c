...
#define BOARD_APP_PMT_START_POS                  ADC16_CONFIG_TRG0A
...
uint8_t trig_channel[] = {BOARD_APP_ADC16_CH_1};
...
void init_sequence_config(void)
{
    ...
    adc16_enable_interrupts(BOARD_APP_ADC16_BASE, adc16_event_seq_full_complete);
...
void init_preemption_config(void)
{
    ...
    init_trigger_cfg(BOARD_APP_ADC16_BASE, BOARD_APP_PMT_START_POS, true);
