...
{
    /* Enable PTPC, use the PTPC channel 0 as the time-stamping source for CAN controller */
    ...
    /* Case 1: Timestamp for CAN message */
    CAN_Type *ptr = BOARD_APP_CAN_BASE;
    can_config_t can_config;
    can_get_default_config(&can_config);
    can_config.baudrate = 1000000; /* 1Mbps */
    ...
    /* Case 2: Timestamp for CANFD message */
    can_get_default_config(&can_config);
    can_config.baudrate = 500000; /* 500kbps */
