...
static void init_lobs_two_group_config(void)
{
    ...
    group_config.sig_group_num = 0;                     /* group0 <--> PA Pins */
    ...
    group_config.group_enable = true;
    group_config.sig_group_num = 1;                     /* group1 <--> PB Pins */
    ...
    state_config.cmp_sig_bit[0] = LOBS_PIN_DI(BOARD_LOBS_TRIG_PIN);    /* Trig Pin */
