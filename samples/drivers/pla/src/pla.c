...
#define BOARD_PLA_1ST_FILTER_IN_END    pla_filter1_inchn7
#define BOARD_PLA_1ST_FILTER_OUT_END    pla_filter1_outchn7
...
void pla_7bit_counter_init(void)
{
    ...
    pla_filter_cfg_t filter_2st_chn_cfg;
    pla_filter_cfg_t filter_3st_chn_cfg;
     ...
     *
     */
    uint8_t pla_1st_filter_out_num = pla_1st_filter_out_8;
