.. _full_duplex_spi_master_polling:
...
- The `full_duplex_master_polling` example project demonstrates the use of SPI in master mode with polling for full-duplex communication between two boards. In this example, one board acts as the SPI master while the other acts as the SPI slave. The master sends a set of data to the slave and simultaneously receives a set of data from the slave.
