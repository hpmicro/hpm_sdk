...
static lv_obj_t * add_list_button(lv_obj_t * parent, uint32_t track_id)
{
    ...
    char *title = _lv_demo_music_get_title(track_id);
    /*    char * artist = _lv_demo_music_get_artist(track_id); */
    ...
    lv_obj_set_style_text_font(title_label, &SourceHanSansCN_Normal_16, 0);
    lv_label_set_text(title_label, title);
    lv_obj_set_grid_cell(title_label, LV_GRID_ALIGN_START, 1, 1, LV_GRID_ALIGN_CENTER, 0, 2);
