...
static uint32_t spectrum_i;
static uint32_t spectrum_i_pause;
static uint32_t bar_ofs;
static uint32_t spectrum_lane_ofs_start;
static uint32_t bar_rot;
...
static const uint16_t rnd_array[30]
    = { 994, 285, 553, 11, 792, 707, 966, 641, 852, 827, 44, 352, 146, 581, 490, 80, 729, 58, 695, 940, 724, 561, 124, 653, 27, 292, 557, 506, 382, 199 };
static bool first_startted;
/**********************
 *      MACROS
 **********************/
...
{
    LV_FONT_DECLARE(SourceHanSansCN_Normal_16);
#if LV_DEMO_MUSIC_LARGE
    font_small = &lv_font_montserrat_22;
    font_large = &lv_font_montserrat_32;
#else
    font_small = &lv_font_montserrat_12;
    font_large = &SourceHanSansCN_Normal_16;
#endif
    ...
    lv_obj_set_grid_dsc_array(cont, grid_cols, grid_rows);
    lv_obj_set_style_grid_row_align(cont, LV_GRID_ALIGN_SPACE_BETWEEN, 0);
    lv_obj_set_grid_cell(title_box, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 0, 1);
    /*    lv_obj_set_grid_cell(icon_box, LV_GRID_ALIGN_STRETCH, 0, 1, LV_ALIGN_CENTER, 4, 1);*/
    lv_obj_set_grid_cell(spectrum_obj, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 2, 1);
    ...
    LV_IMG_DECLARE(hpmicro_logo_large);
    lv_obj_t *logo = lv_img_create(lv_scr_act());
    lv_img_set_src(logo, &hpmicro_logo_large);
...
{
    if (!first_startted) {
        set_init_audio_player_req(id);
        printf("wav_name:%s.\r\n", (char *)_lv_demo_music_get_title(id));
        first_startted = true;
    } else {
        if (id != track_id) {
            _lv_demo_music_list_btn_img(track_id, false);
            track_load(id);
...
void _lv_demo_music_resume(void)
{
    ...
    _lv_demo_music_list_btn_img(track_id, true);
}
...
bool is_music_playing(void) { return playing; }
...
static lv_obj_t *create_title_box(lv_obj_t *parent)
{
    ...
    static const lv_coord_t grid_cols[] = { 90, LV_GRID_FR(1), 90, LV_GRID_TEMPLATE_LAST };
    static const lv_coord_t grid_rows[] = { LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST };
    lv_obj_set_grid_dsc_array(cont, grid_cols, grid_rows);

    lv_obj_t *logo1;
    LV_IMG_DECLARE(hpmicro_logo);
    logo1 = lv_img_create(cont);
    lv_img_set_src(logo1, &hpmicro_logo);
    lv_obj_set_grid_cell(logo1, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 0, 1);
    ...
    lv_obj_set_grid_cell(title_label, LV_GRID_ALIGN_CENTER, 1, 1, LV_GRID_ALIGN_CENTER, 0, 1);
...
static lv_obj_t *create_ctrl_box(lv_obj_t *parent)
{
    ...
    static const lv_coord_t grid_col[]
        = { LV_GRID_FR(2), LV_GRID_FR(3), LV_GRID_FR(5), LV_GRID_FR(5), LV_GRID_FR(5), LV_GRID_FR(3), LV_GRID_FR(2), LV_GRID_TEMPLATE_LAST };
     ...
     *   lv_obj_set_grid_cell(icon, LV_GRID_ALIGN_START, 1, 1,
     *   LV_GRID_ALIGN_CENTER, 0, 1);

     *   icon = lv_img_create(cont);
     *   lv_img_set_src(icon, &img_lv_demo_music_btn_loop);
     *   lv_obj_set_grid_cell(icon, LV_GRID_ALIGN_END, 5, 1,
     *   LV_GRID_ALIGN_CENTER, 0, 1);
     */
    icon = lv_img_create(cont);
...
static void track_load(uint32_t id)
{
    ...
    set_init_audio_player_req(track_id);
    printf("wav_name:%s.\r\n", (char *)_lv_demo_music_get_title(track_id));
}
...
static lv_obj_t *album_img_create(lv_obj_t *parent)
{
    ...
    case 2:
        ...
        spectrum = spectrum_3;
        spectrum_len = ARRAY_SIZE(spectrum_3);
        break;
    case 1:
        lv_img_set_src(img, &img_lv_demo_music_cover_2);
        spectrum = spectrum_2;
        spectrum_len = ARRAY_SIZE(spectrum_2);
        break;
    case 0:
        lv_img_set_src(img, &img_lv_demo_music_cover_3);
        spectrum = spectrum_1;
        spectrum_len = ARRAY_SIZE(spectrum_1);
        break;
    }
