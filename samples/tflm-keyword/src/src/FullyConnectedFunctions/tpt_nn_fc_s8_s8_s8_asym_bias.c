...
int32_t tpt_nn_fc_s8_s8_s8_asym_bias(const int8_t *in_vec,
                    const int8_t *wt_mat,
                    ...
                    q15_t *tmp_buf)
{
    ...
    if(wt_offset == 0)
    {
        while (batch_cnt)
        {
            tpt_nn_vec_mat_mult_t_s8_v2(in_vec,
                                        wt_mat,
                                        bias,
                                        out_vec,
                                        in_offset,
    ...
    else
    {
        while (batch_cnt)
        {
            tpt_nn_vec_mat_mult_t_s8(in_vec,
                                    wt_mat,
                                    bias,
                                    out_vec,
                                    in_offset,
...
int32_t tpt_nn_fc_s8_s8_s8_asym_bias_get_buffer_size(const uint16_t in_vec_col)
{
    (void)in_vec_col;
    return 0;
}