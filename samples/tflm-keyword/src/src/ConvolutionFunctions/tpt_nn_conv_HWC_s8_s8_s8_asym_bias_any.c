...
int32_t tpt_nn_conv_HWC_s8_s8_s8_asym_bias_any(const q7_t *in_tensor,
...
int32_t tpt_nn_conv_HWC_s8_s8_s8_asym_bias_any_get_buffer_size(const uint16_t in_tensor_ch,
                                        const uint16_t ker_dim_x,
                                        const uint16_t ker_dim_y)
{
    (void)in_tensor_ch;
