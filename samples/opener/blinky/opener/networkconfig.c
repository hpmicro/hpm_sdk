...
EipStatus IfaceGetMacAddress(TcpIpInterface *iface, uint8_t *const physical_address)
{
...
static EipStatus GetIpAndNetmaskFromInterface(TcpIpInterface *iface, CipTcpIpInterfaceConfiguration *iface_cfg)
{
...
static EipStatus GetGatewayFromRoute(TcpIpInterface *iface, CipTcpIpInterfaceConfiguration *iface_cfg)
{
...
EipStatus IfaceGetConfiguration(TcpIpInterface *iface, CipTcpIpInterfaceConfiguration *iface_cfg)
{
