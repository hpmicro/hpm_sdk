...
/*
 * VG-Lite requires initialization before use.
 * The `gpu_init()` function will be called by LVGL during initialization.
 * In this sample, `gpu_init()` is implemented to initialize the VG-Lite GPU and
 */
void gpu_init(void)
{
    gpu_vg_lite_startup();
