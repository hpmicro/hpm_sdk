...
This project demonstrates the message queue function of CMSIS OS2 FreeRTOS. This project creates 2 threads, one to send messages, one to receive messages and print them.
