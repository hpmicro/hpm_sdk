.. _cmsis_os2_msg_queue_theadx:

CMSIS OS2 MSG QUEUE (TheadX)
========================================================

Overview
--------

This project demonstrates the message queue function of CMSIS OS2 TheadX. This project creates 2 threads, one to send messages, one to receive messages and print them.
