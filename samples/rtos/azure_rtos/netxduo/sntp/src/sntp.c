...
#if defined(CONFIG_NETX_ENABLE_DHCP) && CONFIG_NETX_ENABLE_DHCP
#define CLIENT_IP_ADDRESS IP_ADDRESS(0, 0, 0, 0)
...
#else
#define CLIENT_IP_ADDRESS IP_ADDRESS(192, 168, 1, 223)
#define SAMPLE_IPV4_MASK 0xFFFFFF00UL
#endif

#define SERVER_IP_ADDRESS IP_ADDRESS(192, 168, 1, 2)
...
VOID tx_application_define(VOID *first_unused_memory)
{
    ...
    status = nx_ip_create(&client_ip, "SNTP IP Instance", CLIENT_IP_ADDRESS,
        SAMPLE_IPV4_MASK, &client_packet_pool, _nx_driver_hpm,
...
VOID demo_client_thread_entry(ULONG info)
{
    ...
    printf("IP address: %lu.%lu.%lu.%lu\r\n", (CLIENT_IP_ADDRESS >> 24), (CLIENT_IP_ADDRESS >> 16 & 0xFF), (CLIENT_IP_ADDRESS >> 8 & 0xFF), (CLIENT_IP_ADDRESS >> 0 & 0xFF));
