...
VOID tx_application_define(VOID *first_unused_memory)
{
    ...
    status = nx_ip_create(&server_ip, "HTTP Server IP", SAMPLE_IPV4_ADDRESS, SAMPLE_IPV4_MASK, &server_pool, _nx_driver_hpm, server_ip_stack, 4096, 1);
    ...
    server_ip_address.nxd_ip_address.v4 = SAMPLE_IPV4_ADDRESS;
