...
/* Define the TraceX vars*/
/* Define the TraceX buffer size*/
#define trace_buffer_size 64000
#define registry_entries 40

/* To use traceX, export the buffer from device to a binary file with trx extension, and open with traceX application*/
