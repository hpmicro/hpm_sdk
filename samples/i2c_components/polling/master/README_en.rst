...
- This example demonstrates the functionality of I2C as a master using polling to transfer data. It includes accessing memory data and pure data of specific slave device registers.
...
- When using hpm_i2c_master_addr_write_blocking and hpm_i2c_master_addr_read_blocking APIs, the endianness of the addr parameter depends on the addr_endianness member of the context parameter. When it is i2c_master_addr_big_endian, the addr transmission is in big-endian mode, otherwise it is in little-endian mode.
