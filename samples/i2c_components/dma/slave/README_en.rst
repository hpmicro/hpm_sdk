...
FULL_DUPLEX_SPI_SLAVE_DMA
==================================================

Overview
--------

- The **i2c_components_slave_dma** example demonstrates the I2C interface operating in slave mode with DMA-based data transfer.
...
- This I2C component uses the DMA manager module, which must be initialized by calling ``dma_mgr_init()`` before use.
