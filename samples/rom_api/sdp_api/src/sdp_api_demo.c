...
static hpm_stat_t sdp_api_aes_ecb_demo(void)
{
    ...
    const uint8_t gold_ct128[16] = { 0x69, 0xc4, 0xe0, 0xd8, 0x6a, 0x7b, 0x04, 0x30, 0xd8, 0xcd, 0xb7, 0x80, 0x70, 0xb4,
                                     0xc5, 0x5a };
    const uint8_t gold_ct256[16] = { 0x8e, 0xa2, 0xb7, 0xca, 0x51, 0x67, 0x45, 0xbf, 0xea, 0xfc, 0x49, 0x90, 0x4b, 0x49,
                                     0x60, 0x89 };
...
hpm_stat_t sdp_api_aes_cbc_demo(void)
{
    ...
    const uint8_t gold_ct256[16] = { 0xf5, 0x8c, 0x4c, 0x04, 0xd6, 0xe5, 0xf1, 0xba, 0x77, 0x9e, 0xab, 0xfb, 0x5f, 0x7b,
                                     0xfb, 0xd6 };
    const uint8_t def_key128[16] = { 0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf,
                                     0x4f, 0x3c };
    const uint8_t def_key256[32] = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d,
                                     0x77, 0x81,
...
hpm_stat_t sdp_api_memcpy_demo(void)
{
    ...
    printf("%s, desc_addr=%x, src_addr=%x, dst_addr=%x\n", __func__, (uint32_t) &p_sdp_ctx->sdp_pkt,
                 (uint32_t) p_sys_src, (uint32_t) p_sys_dst);
