...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1008_manufacturerDeviceName = {'H', 'P', 'M', 'I', 'C', 'R', 'O', ' ', 'C', 'A', 'N', 'o', 'p', 'e', 'n', ' ', 'D', 'e', 'm', 'o', 0},
    ...
    .x1016_consumerHeartbeatTime = {0x000A09C4, 0x000B09C4},
    ...
    .x1280_SDOClientParameter = {
        ...
        .node_IDOfTheSDOServer = 0x02
    },
    .x1400_RPDOCommunicationParameter = {
        .highestSub_indexSupported = 0x05,
        .COB_IDUsedByRPDO = 0x0200,
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2102_PDO_Para = {
        .dataOrig = &OD_RAM.x2102_PDO_Para,
        .attribute = ODA_TRPDO | ODA_TRSRDO | ODA_MB,
        .dataLength = 4
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2102, 0x01, ODT_VAR, &ODObjs.o_2102_PDO_Para, NULL},
