...
function(__sdk_ses_set_section_placement path config_type section_type section_name)
    ...
    if(${section_type_lower} STREQUAL "bss")
        set(section_type_lower "zeroed")
    endif()
...
function(generate_ses_project)
    ...
    get_property(target_ses_defines TARGET ${HPM_SDK_SES_LIB_ITF} PROPERTY INTERFACE_COMPILE_DEFINITIONS)
    ...
    if(NOT "${target_ses_defines}" STREQUAL "")
        foreach (defs IN ITEMS ${target_ses_defines})
            string(REGEX REPLACE "\"" "\\\\\"" escaped ${defs})
            if("${target_defines_escaped}" STREQUAL "")
                set(target_defines_escaped ${escaped})
            else()
