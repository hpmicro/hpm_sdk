...
function (generate_iar_project)
    ...
    if(NOT ${exist} EQUAL -1)
        ...
        STRING(REGEX REPLACE "(rv[A-Za-z0-9]+)_(zi[A-Za-z0-9_]+)" "\\1;\\2" RESULT ${IAR_COMPILER_ARCH})
    ...
    set(target_register_definition "${HPM_SDK_BASE}/soc/${HPM_SOC}/hpm_iar_reg.xml")
    set(target_cpu_register_definition "${HPM_SDK_BASE}/soc/${HPM_SOC}/hpm_iar_riscv_cpu_regs.xml")
